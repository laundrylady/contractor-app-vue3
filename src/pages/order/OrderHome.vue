    ...
    <q-drawer v-model="drawer.left" :width="300" side="left" bordered>
      ...
      <q-list dense class="q-mt-md q-ml-sm q-mr-sm">
        ...
        <q-item v-if="model.contractor">
          ...
          <q-item-section>
            <router-link :to="{ name: 'contractor-dashboard', params: { id: model.contractor.id } }" class="link">{{
              model.contractor.contractor_badge_name }}</router-link>
          </q-item-section>
        </q-item>
        <q-item v-if="model.contractor">
          <q-item-section side>
...
import { fromNowTz, hourBookingDisplay, displayDateDay } from 'src/mixins/help'
