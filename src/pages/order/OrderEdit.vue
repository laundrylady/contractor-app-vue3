  ...
  <q-card>
    <q-list>
      ...
      <q-expansion-item group="orderEdit"
        ...
        caption=" Create, update and delete products for this booking" header-class="text-h6" default-opened>
        <q-card>
          ...
          <div v-if="localModel.invoice">
            ...
            <q-card-section v-if="invoiceTab === 'payments'" style="min-height:300px;">
              <q-list separator>
                <q-item v-if="!model.invoice.payments.length">
                  <q-item-section>No payments found.</q-item-section>
                </q-item>
                <q-item v-for="p in model.invoice.payments" :key="p.id">
                  ...
                  <q-item-section>
                    <div>
                      ...
                      <div>{{ dateTimeTz(p.created_at) }} <span v-if="p.payment_id">| Reference: {{ p.payment_id }}</span>
                      </div>
                    </div>
                  </q-item-section>
                </q-item>
