<template>
  <q-card>
    <q-list>
      <q-expansion-item group="orderEdit" :label="$t('order.details')" header-class="text-h6 bg-grey-2"
      ...
      <q-expansion-item group="orderEdit"
        ...
        caption=" Create, update and delete products" header-class="text-h6 bg-grey-2" default-opened
