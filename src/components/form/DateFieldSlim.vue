<template>
  <q-input :filled="filled" :outlined="outlined" :model-value="modelValue" mask="##/##/####" :label="label"
    style="width:130px;" @update:model-value="handleChange" @blur="checkDate()">
    <template v-slot:append>
      <q-icon name="event" class="cursor-pointer" @blur="checkDate()">
