            ...
            notificationHistory.value && notificationHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(notificationHistory.value, (n) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createTextVNode(" to "),
                  createBaseVNode("span", _hoisted_23$1, toDisplayString(n.to), 1),
                  createBaseVNode("div", null, toDisplayString(unref(dateTimeTz)(n.created_at)), 1)
                ]);
              }), 128))
            ])) : createCommentVNode("", true)
          ])
            ...
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !unref(hasPickupNoShow) ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
                      _hoisted_25$1,
