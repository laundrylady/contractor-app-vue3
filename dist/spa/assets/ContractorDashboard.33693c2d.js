...
import { u as useCircularCommonProps, Q as QCircularProgress } from "./QCircularProgress.982e2e79.js";
import { Q as QItemSection, a as QItem } from "./selection.8acc63c6.js";
import { Q as QList } from "./QList.43f7d494.js";
import { C as ClosePopup } from "./ClosePopup.2629e718.js";
import { m as moment, a as api } from "./axios.3e4f7477.js";
import { T as TouchPan } from "./TouchPan.0075bd33.js";
import { b as between, n as normalizeToInterval } from "./format.de7e9769.js";
import { Q as QItemLabel } from "./QItemLabel.a56031b0.js";
import { _ as _sfc_main$3 } from "./DateField.fec0894f.js";
import { u as useMixinDebug } from "./debug.b9d7424b.js";
import { Q as QMarkupTable } from "./QMarkupTable.df34e0fd.js";
import { l as hourOptions, m as dayOptions, k as currencyFormat } from "./help.87883cc2.js";
...
const _hoisted_15$1 = { class: "col-xs-12 col-md-9" };
const _hoisted_16$1 = { class: "row q-col-gutter-md" };
const _hoisted_17$1 = { class: "text-center" };
const _hoisted_18$1 = { class: "text-h6 text-center" };
const _hoisted_19$1 = { class: "text-center" };
const _hoisted_20$1 = { class: "text-center q-mt-xs" };
const _hoisted_21$1 = {
  key: 2,
  class: "q-mt-md"
};
const _hoisted_22$1 = /* @__PURE__ */ createBaseVNode("pre", null, null, -1);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(QCard, { class: "q-mt-md" }, {
          default: withCtx(() => [
            createVNode(QCardSection, null, {
              default: withCtx(() => [
                createBaseVNode("div", {
                ...
                data.value && data.value.visible.length ? (openBlock(), createElementBlock("div", _hoisted_11$1, [
                  createBaseVNode("div", _hoisted_12$1, [
                    createBaseVNode("div", _hoisted_13$1, toDisplayString(data.value.totals.visible.toFixed(4)) + " kw", 1),
                    createTextVNode(" Total Device Usage "),
                    !_ctx.$q.screen.xs && data.value.hiddenDevices.length ? (openBlock(), createElementBlock("div", _hoisted_14$1, [
                      createVNode(QBtn, {
                    ...
                    createBaseVNode("div", _hoisted_16$1, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(data.value.visible, (d) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_18$1, toDisplayString(d.value.toFixed(4)) + " kw", 1),
                          createBaseVNode("div", _hoisted_19$1, toDisplayString(d.label), 1),
                ...
                showHidden.value && data.value.hiddenDevices.length ? (openBlock(), createElementBlock("div", _hoisted_21$1, [
                  createVNode(QList, {
                    bordered: "",
                    separator: ""
                  }, {
...
const _hoisted_8 = { class: "text-center text-h6 q-mt-sm" };
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Current Capacity", -1);
const _hoisted_20 = { class: "row q-col-gutter-md" };
const _hoisted_21 = { class: "text-center" };
const _hoisted_22 = { class: "q-mb-sm" };
const _hoisted_23 = { class: "col-xs-12 col-sm-6" };
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Invoicing", -1);
const _hoisted_25 = { class: "row q-col-gutter-md" };
const _hoisted_26 = { class: "col-xs-6" };
const _hoisted_27 = { class: "text-h6 text-center" };
const _hoisted_28 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, "Invoiced", -1);
const _hoisted_29 = { class: "col-xs-6" };
const _hoisted_30 = { class: "text-h6 text-center" };
const _hoisted_31 = { class: "text-center" };
const _hoisted_32 = { key: 0 };
const _hoisted_33 = { class: "text-negative" };
const _hoisted_34 = { class: "col-xs-12 col-sm-6" };
const _hoisted_35 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Bookings", -1);
const _hoisted_36 = { class: "row q-col-gutter-md" };
const _hoisted_37 = { class: "col-xs-6" };
const _hoisted_38 = { class: "text-h6 text-center" };
const _hoisted_39 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, "Total", -1);
const _hoisted_40 = { class: "col-xs-6" };
const _hoisted_41 = { class: "text-h6 text-center" };
const _hoisted_42 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, " Recurring ", -1);
const _hoisted_43 = { class: "col-xs-12 col-sm-6" };
const _hoisted_44 = { class: "text-h6 q-mb-md" };
const _hoisted_45 = { class: "text-center" };
const _hoisted_46 = { class: "q-mt-sm" };
...
const _hoisted_51 = { class: "text-h6" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.model.id && dashboard.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
              ...
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_8, toDisplayString(unref(currencyFormat)(dashboard.value.weeklyOrders.sum)) + " / " + toDisplayString(unref(currencyFormat)(__props.model.contractor_target)), 1)
                  ]),
                  _: 1
                })
              ]),
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_25, [
                      createBaseVNode("div", _hoisted_26, [
                        createBaseVNode("div", _hoisted_27, toDisplayString(unref(currencyFormat)(dashboard.value.totalOrdersTotalPrice[0].sum)), 1),
                        _hoisted_28
                      ]),
                      createBaseVNode("div", _hoisted_29, [
                        createBaseVNode("div", _hoisted_30, toDisplayString(unref(currencyFormat)(dashboard.value.totalOrdersTotalOwingGrand)), 1),
                            ...
                            default: withCtx(() => [
                              createVNode(QItemSection, null, {
                                default: withCtx(() => [
                                  ...
                                  u.team ? (openBlock(), createElementBlock("span", _hoisted_32, toDisplayString(u.team.name), 1)) : createCommentVNode("", true)
                                ]),
                                _: 2
                              }, 1024),
                              createVNode(QItemSection, { side: "" }, {
                                default: withCtx(() => [
                                  createBaseVNode("span", _hoisted_33, toDisplayString(unref(currencyFormat)(u.grand_total_price)), 1),
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_36, [
                      createBaseVNode("div", _hoisted_37, [
                        createBaseVNode("div", _hoisted_38, toDisplayString(dashboard.value.totalOrdersCount[0].count), 1),
                        _hoisted_39
                      ]),
                      createBaseVNode("div", _hoisted_40, [
                        createBaseVNode("div", _hoisted_41, toDisplayString(dashboard.value.totalOrdersCountRecurring[0].count), 1),
                        _hoisted_42
                      ])
                    ])
                  ]),
          ...
          createBaseVNode("div", _hoisted_43, [
            createVNode(QCard, { class: "fit" }, {
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_44, toDisplayString(_ctx.$t("team.namePlural")) + " Rebooked", 1),
                    createBaseVNode("div", _hoisted_45, [
                      ...
                      createBaseVNode("div", _hoisted_46, "Rebooked (" + toDisplayString(dashboard.value.retainedRebooked.rebookedPercentage) + "%)", 1)
                    ])
                  ]),
                  _: 1
                })
          ...
          createBaseVNode("div", _hoisted_47, [
            createVNode(QCard, { class: "fit" }, {
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_48, toDisplayString(_ctx.$t("team.namePlural")) + " Retained", 1),
                    createBaseVNode("div", _hoisted_49, [
                      ...
                      createBaseVNode("div", _hoisted_50, " Retained (" + toDisplayString(dashboard.value.retainedRebooked.retainedPercentage) + "%) ", 1)
                    ])
                  ]),
                  _: 1
                })
        ...
        createBaseVNode("div", _hoisted_51, "Current " + toDisplayString(_ctx.$t("schedule.name")), 1),
        _hoisted_52,
