import { V as createComponent, r as ref, g as computed, w as watch, E as onBeforeUnmount, h, H as Transition, X as hSlot, aJ as QSpinner, A as defineComponent, m as openBlock, K as createBlock, L as withCtx, U as unref, y as createCommentVNode, R as createTextVNode, aI as toDisplayString, bu as QAvatar } from "./index.1b2f6b7e.js";
      ...
      return openBlock(), createBlock(QAvatar, {
        ...
        default: withCtx(() => [
          unref(userDetails).avatar ? (openBlock(), createBlock(QImg, {
            key: 0,
            src: `/api/user/useravatar?fetch=thumb&userId=${unref(userDetails).id}&cb=${new Date().getTime()}`,
            fit: "contain",
            "no-spinner": "",
            "no-transition": ""
