import { j as getCurrentInstance, r as ref, a8 as onBeforeMount, w as watch, k as isRef, B as reactive, E as onBeforeUnmount, g as computed, U as unref, a9 as isReactive, aa as isReadonly, i as inject, $ as provide, D as nextTick } from "./index.f0b4ebe6.js";
...
regex(/(^[0-9]*$)|(^-[0-9]+$)/);
regex(/^[-]?\d*(\.\d+)?$/);
export { requiredIf as a, email as e, required as r, useVuelidate as u };
