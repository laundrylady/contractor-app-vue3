import { Q as QTab } from "./QTab.ad817cd4.js";
import { Q as QTabs } from "./QTabs.5542e123.js";
import { B as defineComponent, r as ref, g as computed, i as inject, C as reactive, o as onMounted, m as openBlock, n as createElementBlock, q as createBaseVNode, F as Fragment, be as renderList, t as normalizeClass, ak as createTextVNode, aj as toDisplayString, S as unref, z as createCommentVNode, l as createVNode, bf as createSlots, L as withCtx, R as QBtn, N as QInput, O as QIcon, H as withDirectives, K as createBlock, bw as QSeparator, Q as QCard, M as QCardSection, ab as QCardActions, aH as QDialog, J as useRouter, by as resolveComponent, bg as QCheckbox, al as QToggle, bo as Dialog } from "./index.706d8900.js";
import { Q as QBadge } from "./QBadge.89672429.js";
import { Q as QSelect } from "./QSelect.e5026263.js";
import { Q as QSpace } from "./QSpace.a073d5d3.js";
import { Q as QExpansionItem } from "./QExpansionItem.e45b3426.js";
import { a as QItem, Q as QItemSection } from "./QItemSection.79ddbbc8.js";
import { Q as QList } from "./QList.4764cd18.js";
import { Q as QItemLabel } from "./QItemLabel.31304aca.js";
import { Q as QToolbar, a as QToolbarTitle } from "./QToolbarTitle.6bf94d77.js";
import { C as ClosePopup } from "./ClosePopup.275d9e02.js";
import { u as useVuelidate, r as required, a as requiredIf } from "./index.esm.58ee1ada.js";
import { a as api } from "./axios.8acee7c7.js";
import { _ as _sfc_main$4 } from "./UserAvatar.dd39f18e.js";
import { _ as _sfc_main$8 } from "./AuditTimeline.f1df4954.js";
import { _ as _sfc_main$5, a as _sfc_main$6, b as _sfc_main$7 } from "./PostcodeRegionField.944ecf17.js";
import { _ as _sfc_main$2 } from "./DateField.ec0e5d2e.js";
import { Q as QMenu } from "./QMenu.90cbb366.js";
import { u as useMixinDebug } from "./debug.972d445d.js";
import { r as groupBy, j as currencyFormat, z as dateTimeTz, d as hourBookingOptions, c as confirmDelete, e as doNotify, b as arrayRange, h as hourBookingDisplay, D as agreedTimes, g as hourAgreedDisplay, f as displayDateDay, E as cancelOrderReasons, F as changeOrderReasonsDelivery, G as changeOrderReasons } from "./help.e2addada.js";
import { _ as _sfc_main$3 } from "./GlobalNotes.f51bce7e.js";
import { _ as _sfc_main$9 } from "./GlobalNotifications.f27f7bfe.js";
import { u as useMixinSecurity } from "./security.2c72e984.js";
import { p as productCategoriesVisibleBooking } from "./helpers.8033d92e.js";
import { u as useI18n } from "./vue-i18n.runtime.esm-bundler.880a6508.js";
import "./QResizeObserver.3a771471.js";
import "./rtl.b51694b1.js";
import "./format.3e32b8d9.js";
import "./QSlideTransition.757f06de.js";
import "./QImg.9c1306fa.js";
import "./use-ratio.59db937a.js";
...
import "./common.ba6b96ca.js";
import "./common.e0ca0a46.js";
...
const _hoisted_20$1 = /* @__PURE__ */ createBaseVNode("p", null, "Please confirm the scheduled delivery date & time below:", -1);
const _hoisted_21$1 = { class: "row q-col-gutter-md" };
const _hoisted_22$1 = { class: "col-xs-12 col-sm-6" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          createBaseVNode("div", _hoisted_16$1, [
            createBaseVNode("div", _hoisted_17$1, [
              unref(canSend) ? (openBlock(), createBlock(QBtn, {
                key: 0,
                onClick: _cache[2] || (_cache[2] = ($event) => doSendPaymentRequest("sms")),
                icon: "chat",
              ...
              unref(canSend) ? (openBlock(), createBlock(QBtn, {
                key: 1,
                onClick: _cache[3] || (_cache[3] = ($event) => doSendPaymentRequest("email")),
                icon: "mail",
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => sendPaymentModal.value.show = $event)
        }, {
          default: withCtx(() => [
              ...
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_21$1, [
                      createBaseVNode("div", _hoisted_22$1, [
                        createVNode(_sfc_main$2, {
                          ...
                          "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => sendPaymentModal.value.scheduled_delivery_date = $event),
                          label: "Scheduled delivery date",
                          outlined: true,
                          invalid: !sendPaymentModal.value.scheduled_delivery_date
                        }, null, 8, ["modelValue", "invalid"])
                      ]),
                      createBaseVNode("div", _hoisted_23$1, [
                        createVNode(QSelect, {
                          modelValue: sendPaymentModal.value.scheduled_delivery_time,
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => sendPaymentModal.value.scheduled_delivery_time = $event),
                          label: "Scheduled delivery time",
                          outlined: true,
                          options: unref(hourBookingOptions),
                          error: !sendPaymentModal.value.scheduled_delivery_time,
                          "map-options": "",
                          "emit-value": ""
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => sendPaymentModal.value.content = $event),
                      type: "textarea",
                      outlined: "",
                      rows: "3",
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[7] || (_cache[7] = ($event) => sendPaymentRequest()),
                      color: "primary",
                      label: "Send via email",
                      rounded: "",
                      disable: sendingPaymentRequest.value || !sendPaymentModal.value.scheduled_delivery_date || !sendPaymentModal.value.scheduled_delivery_time
                    }, null, 8, ["disable"])
                  ]),
                  _: 1
                })
...
const _hoisted_37 = { class: "text-bold text-grey q-mb-xs q-mt-md" };
const _hoisted_38 = { key: 0 };
const _hoisted_39 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold text-grey q-mt-md" }, "PRODUCTS", -1);
const _hoisted_40 = {
  key: 4,
  class: "q-mt-md"
};
...
const _hoisted_62 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP DATE", -1);
const _hoisted_63 = { class: "col-xs-12 col-sm-6" };
const _hoisted_64 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP TIME", -1);
...
const _hoisted_69 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY DATE", -1);
const _hoisted_70 = { class: "col-xs-12 col-sm-6" };
const _hoisted_71 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY TIME", -1);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
            ...
            createVNode(QList, null, {
              default: withCtx(() => [
                createVNode(QExpansionItem, {
                  ...
                  onClick: _cache[26] || (_cache[26] = ($event) => bookingTab.value = "details"),
                        ...
                        createVNode(QCardSection, null, {
                          default: withCtx(() => [
                            ...
                            bookingTab.value === "details" ? (openBlock(), createElementBlock("div", _hoisted_1, [
                              ...
                              unref(localModel).suburbpostcoderegion ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(unref(localModel).suburbpostcoderegion.locality) + " " + toDisplayString(unref(localModel).suburbpostcoderegion.state) + " " + toDisplayString(unref(localModel).postcode), 1)) : createCommentVNode("", true),
                              ...
                              unref(localModel).scheduled_delivery_date || ["ready_for_delivery", "awaiting_payment"].indexOf(unref(localModel).status) !== -1 ? (openBlock(), createElementBlock("div", _hoisted_25, [
                                ...
                                createBaseVNode("div", _hoisted_30, [
                                  _hoisted_31,
                                  !changes.value.timeDelivery ? (openBlock(), createElementBlock("div", _hoisted_32, [
                                    unref(localModel).scheduled_delivery_time ? (openBlock(), createElementBlock("span", _hoisted_33, toDisplayString(unref(hourBookingDisplay)(unref(localModel).scheduled_delivery_time)), 1)) : createCommentVNode("", true),
                                    unref(canEditDelivery) ? (openBlock(), createBlock(QBtn, {
                                      key: 1,
                                    ...
                                    unref(localModel).agreed_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_34, "Agreed: " + toDisplayString(unref(hourAgreedDisplay)(unref(localModel).agreed_delivery_time)), 1)) : createCommentVNode("", true)
                                  ])) : createCommentVNode("", true),
                                  changes.value.timeDelivery ? (openBlock(), createElementBlock("div", _hoisted_35, [
                                    createVNode(QSelect, {
                                    ...
                                    unref(canEdit) && changes.value.timeDelivery || unref(localModel).agreed_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_36, [
                                      ...
                                      !changes.value.timeDelivery && unref(localModel).agreed_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_38, [
                              ...
                              !unref(localModel).recurring_parent_id ? (openBlock(), createElementBlock("div", _hoisted_40, [
                                createVNode(QToggle, {
                                ...
                                unref(localModel).recurring_order ? (openBlock(), createElementBlock("div", {
                                  ...
                                  createBaseVNode("div", _hoisted_41, [
                                    ...
                                    __props.model.recurring ? (openBlock(), createElementBlock("div", _hoisted_43, [
                                      createVNode(QSelect, {
                                        modelValue: unref(localModel).recurring_every,
                                        "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => unref(localModel).recurring_every = $event),
                                        label: "Repeat every",
                                    ...
                                    __props.model.recurring ? (openBlock(), createElementBlock("div", _hoisted_44, [
                                      createVNode(QSelect, {
                                        ...
                                        "onUpdate:modelValue": [
                                          _cache[19] || (_cache[19] = ($event) => unref(localModel).recurring_end_type = $event),
                                          _cache[20] || (_cache[20] = ($event) => unref(localModel).recurring_end = "")
                                        ],
                                        label: "Ends",
                                    ...
                                    __props.model.recurring ? (openBlock(), createElementBlock("div", _hoisted_45, [
                                      unref(localModel).recurring_end_type === "After" ? (openBlock(), createBlock(QSelect, {
                                        key: 0,
                                        modelValue: unref(localModel).recurring_end,
                                        "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => unref(localModel).recurring_end = $event),
                        ...
                        bookingTab.value === "details" ? (openBlock(), createBlock(QCardActions, { key: 0 }, {
                          default: withCtx(() => [
                            unref(localModel).status !== "cancelled" && (!unref(localModel).invoice || unref(localModel).invoice && unref(localModel).invoice.status !== "PAID") ? (openBlock(), createBlock(QBtn, {
                              key: 0,
                              onClick: _cache[23] || (_cache[23] = ($event) => showCancelOrder.value = true),
                              color: "red",
                            ...
                            changes.value.time || changes.value.date || changes.value.timeDelivery || changes.value.dateDelivery || changes.value.contractor ? (openBlock(), createBlock(QBtn, {
                              ...
                              flat: "",
                              color: "secondary",
                              onClick: _cache[24] || (_cache[24] = ($event) => resetChangeModel()),
                              rounded: ""
                            }, null, 8, ["label"])) : createCommentVNode("", true),
                            createVNode(QBtn, {
                              ...
                              color: "primary",
                              onClick: _cache[25] || (_cache[25] = ($event) => save()),
                              rounded: ""
                ...
                unref(localModel).status !== "cancelled" ? (openBlock(), createBlock(QExpansionItem, {
                  ...
                  "header-class": "text-h6",
                  "default-opened": "",
                  onClick: _cache[37] || (_cache[37] = ($event) => invoiceTab.value = "products")
                }, {
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                        !unref(localModel).invoice ? (openBlock(), createBlock(QCardSection, { key: 0 }, {
                          default: withCtx(() => [
                            ...
                            createVNode(QBtn, {
                              ...
                              onClick: _cache[27] || (_cache[27] = ($event) => createInvoice()),
                              color: "primary",
                              icon: "add_circle",
                              rounded: ""
                            })
                        ...
                        unref(localModel).invoice ? (openBlock(), createElementBlock("div", _hoisted_46, [
                          createVNode(QTabs, {
                            modelValue: invoiceTab.value,
                            "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => invoiceTab.value = $event),
                            align: "left"
                          }, {
                            default: withCtx(() => [
                              createVNode(QTab, {
                          ...
                          invoiceTab.value === "notes" ? (openBlock(), createElementBlock("div", _hoisted_47, [
                          ...
                          invoiceTab.value === "config" ? (openBlock(), createBlock(QCardSection, { key: 2 }, {
                            default: withCtx(() => [
                              createBaseVNode("div", _hoisted_48, [
                                createBaseVNode("div", _hoisted_49, [
                                  createVNode(_sfc_main$2, {
                                    ...
                                    "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => unref(localModel).invoice.invoice_date = $event),
                                    label: _ctx.$t("invoice.invoiceDate")
                                  }, null, 8, ["modelValue", "label"])
                                ]),
                                createVNode(QInput, {
                                  modelValue: unref(localModel).invoice.invoice_po,
                                  "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => unref(localModel).invoice.invoice_po = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => unref(localModel).invoice.invoice_name = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => unref(localModel).invoice.invoice_address1 = $event),
                                label: _ctx.$t("address.line1"),
                                "bottom-slots": ""
                              }, null, 8, ["modelValue", "label"]),
                              createVNode(QInput, {
                                modelValue: unref(localModel).invoice.invoice_address2,
                                "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => unref(localModel).invoice.invoice_address2 = $event),
                              ...
                              createBaseVNode("div", _hoisted_50, [
                                createVNode(_sfc_main$6, {
                                  ...
                                  "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => unref(localModel).invoice.invoice_address_suburb_postcode_region_id = $event),
                                  label: _ctx.$t("address.suburb"),
                                  class: "col-xs-12 col-sm-6"
                                }, null, 8, ["modelValue", "label"]),
                                createVNode(_sfc_main$7, {
                                  modelValue: unref(localModel).invoice.invoice_address_country_id,
                                  "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => unref(localModel).invoice.invoice_address_country_id = $event),
                              ...
                              createBaseVNode("div", _hoisted_51, [
                                createVNode(QBtn, {
                                  ...
                                  label: _ctx.$t("actions.update"),
                                  color: "primary",
                                  onClick: _cache[36] || (_cache[36] = ($event) => saveInvoice()),
                                  rounded: ""
                                }, null, 8, ["disable", "label"])
                              ])
                            ]),
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("div", null, [
                          createVNode(_component_router_link, {
                            ...
                            default: withCtx(() => [
                              o.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_52, toDisplayString(unref(displayDateDay)(o.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                              createTextVNode(" " + toDisplayString(o.scheduled_pickup_date) + " (", 1),
                              !o.agreed_pickup_time && o.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_53, toDisplayString(unref(hourBookingDisplay)(o.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                              o.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_54, toDisplayString(unref(hourAgreedDisplay)(o.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                              createTextVNode(")")
                            ]),
                            _: 2
                          }, 1032, ["to"])
                        ...
                        createBaseVNode("div", _hoisted_55, [
                          ...
                          createTextVNode(),
                          o.productcategories ? (openBlock(), createElementBlock("span", _hoisted_56, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(o.productcategories, (c, index) => {
                              return openBlock(), createElementBlock("span", {
                                ...
                                index + 1 !== o.productcategories.length ? (openBlock(), createElementBlock("span", _hoisted_57, "&")) : createCommentVNode("", true)
                              ]);
                            }), 128)),
                        ...
                        createBaseVNode("div", _hoisted_58, [
                          ...
                          createTextVNode(),
                          o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_59, toDisplayString(o.team.suburbpostcoderegion.locality) + " " + toDisplayString(o.team.suburbpostcoderegion.state), 1)) : createCommentVNode("", true)
                        ])
                      ])
                    ]),
                    _: 2
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[42] || (_cache[42] = ($event) => showCancelOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createVNode(QSelect, {
                      ...
                      "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => unref(localModel).cancel_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => unref(localModel).cancel_notes = $event),
                    ...
                    createVNode(QCheckbox, {
                      ...
                      "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => unref(localModel).cancel_rebook = $event),
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[41] || (_cache[41] = ($event) => cancelOrder()),
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[46] || (_cache[46] = ($event) => showChangesOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !__props.model.scheduled_delivery_date ? (openBlock(), createElementBlock("div", _hoisted_60, [
                      ...
                      createBaseVNode("div", _hoisted_63, [
                        _hoisted_64,
                        !changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_65, toDisplayString(unref(hourBookingDisplay)(changes.value.time_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_66, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_time_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    __props.model.scheduled_delivery_date || __props.model.scheduled_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_67, [
                      ...
                      createBaseVNode("div", _hoisted_70, [
                        _hoisted_71,
                        !changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_72, toDisplayString(unref(hourBookingDisplay)(changes.value.timeDelivery_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_73, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_timeDelivery_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    createVNode(QSelect, {
                      modelValue: unref(localModel).changes_reason,
                      "onUpdate:modelValue": _cache[43] || (_cache[43] = ($event) => unref(localModel).changes_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => unref(localModel).changes_notes = $event),
                      label: "Extra notes for the customer",
                      type: "textarea",
                      rows: "3",
                      outlined: "",
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[45] || (_cache[45] = ($event) => doSave()),
