...
const _hoisted_15 = { class: "text-h7 q-mt-xs" };
const _hoisted_16 = {
  key: 1,
  style: { "border": "#cf1677 1px dashed" }
};
const _hoisted_17 = { class: "flex no-wrap" };
const _hoisted_18 = { key: 0 };
const _hoisted_19 = { key: 1 };
const _hoisted_20 = { key: 2 };
const _hoisted_21 = { class: "flex" };
const _hoisted_22 = { key: 0 };
const _hoisted_23 = { class: "q-ml-xs text-right" };
const _hoisted_24 = {
  key: 0,
  class: "q-mb-xs"
};
const _hoisted_25 = { class: "text-h7 q-mt-xs" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(list), (o) => {
              return openBlock(), createBlock(QItem, {
                key: o.id,
                style: normalizeStyle([__props.dense ? "padding:0" : "", { "padding-left": "10px", "padding-right": "10px" }]),
                class: normalizeClass([unref(orderColor)(o), "q-mb-xs"])
              }, {
                default: withCtx(() => [
                        ...
                        createBaseVNode("div", _hoisted_4, [
                          createBaseVNode("div", null, [
                            createBaseVNode("div", null, [
                              ...
                              __props.status ? (openBlock(), createElementBlock("span", _hoisted_5, [
                            ...
                            createBaseVNode("div", null, [
                              createVNode(_component_router_link, {
                                ...
                                default: withCtx(() => [
                                  o.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_6, toDisplayString(unref(displayDateOrder)(o.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                                  createTextVNode(" ("),
                                  !o.agreed_pickup_time && o.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_7, toDisplayString(unref(hourBookingDisplay)(o.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                                  o.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_8, toDisplayString(unref(hourAgreedDisplay)(o.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                                  createTextVNode(") "),
                              ...
                              createBaseVNode("div", null, [
                                createBaseVNode("div", null, [
                                  ...
                                  o.team.name !== `${o.team.first_name} ${o.team.last_name}` ? (openBlock(), createElementBlock("span", _hoisted_9, "(" + toDisplayString(o.team.first_name) + " " + toDisplayString(o.team.last_name) + ")", 1)) : createCommentVNode("", true)
                                ]),
                                createBaseVNode("div", _hoisted_10, [
                                  createVNode(_sfc_main$1, { o }, null, 8, ["o"]),
                                  __props.bookingId ? (openBlock(), createElementBlock("span", _hoisted_11, toDisplayString(o.contractor.contractor_badge_name), 1)) : createCommentVNode("", true),
                                  o.invoice && o.invoice.due_date ? (openBlock(), createBlock(QBadge, {
                                    key: 1,
                                    label: `DUE: ${unref(displayDateDue)(o.invoice.due_date)}`
                                  }, null, 8, ["label"])) : createCommentVNode("", true),
                                  o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("div", _hoisted_12, [
                          ...
                          createBaseVNode("div", _hoisted_13, [
                            o.contractor_user_id === ((_a = unref(user)) == null ? void 0 : _a.id) ? (openBlock(), createElementBlock("div", _hoisted_14, [
                  ...
                  o.grand_total_price > 0 ? (openBlock(), createBlock(QItemSection, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_15, toDisplayString(unref(currencyFormat)(o.grand_total_price)), 1)
                    ]),
                    _: 2
                  }, 1024)) : createCommentVNode("", true)
                ]),
        ...
        reorder.value ? (openBlock(), createElementBlock("div", _hoisted_16, [
              ...
              createVNode(QItem, {
                ...
                default: withCtx(() => [
                  ...
                  createVNode(QItemSection, null, {
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_17, [
                        createBaseVNode("div", null, [
                          createBaseVNode("div", null, [
                            createBaseVNode("div", null, " Booking: #" + toDisplayString(element.display_id), 1),
                            createVNode(_component_router_link, {
                              to: { name: "order-edit", params: { id: element.id } },
                              class: "link"
                            }, {
                              default: withCtx(() => [
                                element.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_18, toDisplayString(unref(displayDateOrder)(element.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" ("),
                                !element.agreed_pickup_time && element.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_19, toDisplayString(unref(hourBookingDisplay)(element.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                                element.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_20, toDisplayString(unref(hourAgreedDisplay)(element.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                                createTextVNode(")")
                              ]),
                              _: 2
                            }, 1032, ["to"])
                          ...
                          createBaseVNode("div", null, [
                            ...
                            createBaseVNode("div", _hoisted_21, [
                              ...
                              element.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString(element.team.suburbpostcoderegion.locality), 1)) : createCommentVNode("", true)
                            ])
                          ])
                        ]),
                        createVNode(QSpace),
                        createBaseVNode("div", _hoisted_23, [
                          __props.status ? (openBlock(), createElementBlock("div", _hoisted_24, [
                            createVNode(_sfc_main$7, {
                  ...
                  element.grand_total_price > 0 ? (openBlock(), createBlock(QItemSection, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_25, toDisplayString(unref(currencyFormat)(element.grand_total_price)), 1)
                    ]),
                    _: 2
                  }, 1024)) : createCommentVNode("", true)
                ]),
