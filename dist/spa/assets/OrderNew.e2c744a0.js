import { B as defineComponent, r as ref, w as watch, o as onMounted, m as openBlock, n as createElementBlock, l as createVNode, L as withCtx, M as QCardSection, q as createBaseVNode, O as QIcon, ak as createTextVNode, aj as toDisplayString, z as createCommentVNode, F as Fragment, be as renderList, S as unref, Q as QCard, aa as useRoute, g as computed, C as reactive, i as inject, G as onBeforeUnmount, K as createBlock, t as normalizeClass, R as QBtn, bg as QCheckbox, N as QInput, al as QToggle } from "./index.ae929d54.js";
import { Q as QDate } from "./QDate.5bd2f554.js";
import { Q as QSelect } from "./QSelect.05b73f42.js";
import { Q as QPage } from "./QPage.c4609f3e.js";
import { Q as QLayout, a as QPageContainer } from "./QLayout.175ccf69.js";
import { _ as _imports_0$1 } from "./ndis_heart.0820b9e2.js";
import { u as useVuelidate, r as required, a as requiredIf, e as email } from "./index.esm.cf233ced.js";
import { a as api, m as moment } from "./axios.e451d1c8.js";
import { u as useQuasar } from "./use-quasar.c230fff0.js";
import { a as _sfc_main$3, _ as _sfc_main$5, b as _sfc_main$6 } from "./PostcodeRegionField.8ea28861.js";
import { u as useMixinDebug } from "./debug.972d445d.js";
import { a as categoryDisplay, h as hourBookingDisplay, c as confirmDelete } from "./help.bd5e4abe.js";
import { p as productCategoriesVisibleBooking } from "./helpers.9639d26c.js";
import { _ as _sfc_main$2 } from "./AppLogo.cdce50fc.js";
import { _ as _sfc_main$4 } from "./OrderContractorManagement.c5b16fd9.js";
import { u as useMixinCommon } from "./common.282eba2e.js";
                            ...
                            default: withCtx(() => [
                              ...
                              createBaseVNode("div", _hoisted_22, [
                                createVNode(QDate, {
                                  ...
                                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => model.scheduled_pickup_date = $event),
                                  mask: "DD/MM/YYYY",
                                  options: minDate,
                                  class: "q-mt-md",
                              ...
                              createBaseVNode("div", _hoisted_23, [
                                createVNode(QBtn, {
                                  onClick: _cache[14] || (_cache[14] = ($event) => stepMove(2)),
                                  color: "primary",
                                  label: "Previous",
                                  flat: "",
                                  class: "q-mr-sm",
                                ...
                                createVNode(QBtn, {
                                  onClick: _cache[15] || (_cache[15] = ($event) => stepMove(4)),
                                  color: "primary",
                                  label: "Continue",
                          ...
                          step.value === 4 ? (openBlock(), createBlock(QCardSection, { key: 3 }, {
                            default: withCtx(() => [
                                  ...
                                  createVNode(QCardSection, null, {
                                    default: withCtx(() => [
                                      model.suburb_postcode_region_id && model.scheduled_pickup_date && model.productcategories.filter((o) => o.active).length ? (openBlock(), createBlock(_sfc_main$4, {
                                        ...
                                        "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => model.contractor_user_id = $event),
                                        reassign: true,
                              ...
                              createBaseVNode("div", _hoisted_25, [
                                createVNode(QBtn, {
                                  onClick: _cache[17] || (_cache[17] = ($event) => stepMove(3)),
                                  color: "primary",
                                  label: "Previous",
                                  flat: "",
                                  class: "q-mr-sm",
                                ...
                                createVNode(QBtn, {
                                  onClick: _cache[18] || (_cache[18] = ($event) => stepMove(5)),
                                  color: "primary",
                                  label: "Continue",
                          ...
                          step.value === 5 ? (openBlock(), createBlock(QCardSection, { key: 4 }, {
                            default: withCtx(() => [
                                    ...
                                    default: withCtx(() => {
                                      ...
                                      return [
                                        ...
                                        createBaseVNode("div", _hoisted_28, [
                                          createBaseVNode("div", _hoisted_29, [
                                            createVNode(QSelect, {
                                              ...
                                              "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => model.team.type = $event),
                                        ...
                                        ["Business", "Aged Care", "Sporting Group"].indexOf(model.team.type || "") !== -1 ? (openBlock(), createElementBlock("div", _hoisted_30, [
                                          createBaseVNode("div", _hoisted_31, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => model.team.name = $event),
                                          ...
                                          ["Business", "Aged Care", "Sporting Group"].indexOf(model.team.type || "") !== -1 ? (openBlock(), createElementBlock("div", _hoisted_32, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => model.team.abn = $event),
                                        ...
                                        model.team.type === "NDIS" ? (openBlock(), createElementBlock("div", _hoisted_33, [
                                          createBaseVNode("div", _hoisted_34, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => model.team.ndis_number = $event),
                                          ...
                                          createBaseVNode("div", _hoisted_36, [
                                            createVNode(QSelect, {
                                              ...
                                              "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => model.team.ndis_type = $event),
                                        ...
                                        createBaseVNode("div", _hoisted_37, [
                                          createBaseVNode("div", _hoisted_38, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => model.team.first_name = $event),
                                          ...
                                          createBaseVNode("div", _hoisted_39, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => model.team.last_name = $event),
                                          ...
                                          createBaseVNode("div", _hoisted_40, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => model.team.email = $event),
                                          ...
                                          createBaseVNode("div", _hoisted_41, [
                                            createVNode(QInput, {
                                              ...
                                              "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => model.team.mobile = $event),
                                        ...
                                        createVNode(QInput, {
                                          ...
                                          "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => model.address1 = $event),
                                        ...
                                        createVNode(QInput, {
                                          ...
                                          "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => model.address2 = $event),
                                        ...
                                        createBaseVNode("div", _hoisted_44, [
                                          createVNode(_sfc_main$3, {
                                            modelValue: model.suburb_postcode_region_id,
                                            "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => model.suburb_postcode_region_id = $event),
                                            invalid: unref($v).suburb_postcode_region_id.$invalid,
                                          ...
                                          createVNode(QInput, {
                                            ...
                                            "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => model.postcode = $event),
                                          ...
                                          createVNode(_sfc_main$6, {
                                            ...
                                            "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => model.country_id = $event),
                              ...
                              createBaseVNode("div", _hoisted_45, [
                                createVNode(QBtn, {
                                  onClick: _cache[33] || (_cache[33] = ($event) => stepMove(4)),
                                  color: "primary",
                                  label: "Previous",
                                  flat: "",
                                  class: "q-mr-sm",
                                ...
                                createVNode(QBtn, {
                                  onClick: _cache[34] || (_cache[34] = ($event) => stepMove(6)),
                                  color: "primary",
                                  label: "Continue",
                          ...
                          step.value === 6 ? (openBlock(), createBlock(QCardSection, { key: 5 }, {
                            default: withCtx(() => [
                                  ...
                                  !success.value && !error.value ? (openBlock(), createBlock(QCardSection, { key: 0 }, {
                                    default: withCtx(() => [
                                      ...
                                      createVNode(QInput, {
                                        ...
                                        "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => model.special_instructions = $event),
                                        class: "q-mt-lg",
                                        type: "textarea",
                                      ...
                                      createVNode(QToggle, {
                                        ...
                                        "onUpdate:modelValue": _cache[36] || (_cache[36] = ($event) => model.recurring_order = $event),
                                      ...
                                      model.recurring_order ? (openBlock(), createBlock(QSelect, {
                                        ...
                                        "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => model.recurring = $event),
                              ...
                              !success.value ? (openBlock(), createElementBlock("div", _hoisted_53, [
                                createVNode(QBtn, {
                                  onClick: _cache[38] || (_cache[38] = ($event) => stepMove(5)),
                                  color: "primary",
                                  label: "Previous",
                                  flat: "",
                                  class: "q-mr-sm",
                                ...
                                createVNode(QBtn, {
                                  onClick: _cache[39] || (_cache[39] = ($event) => save()),
                                  color: "primary",
