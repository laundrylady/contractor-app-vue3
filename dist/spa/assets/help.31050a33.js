import { c as commonjsGlobal, m as moment } from "./axios.c33bd943.js";
import { bs as Notify, bt as Dialog, aU as Platform } from "./index.f0bcd142.js";
var lodash = { exports: {} };
/**
 * @license
...
const dayDisplay = (val) => {
  var _a;
  return (_a = dayOptions.find((o) => o.value === val)) == null ? void 0 : _a.label;
};
const hourDisplay = (val) => {
  var _a;
  return (_a = hourOptions.find((o) => o.value === val)) == null ? void 0 : _a.label;
};
const hourBookingDisplay = (val) => {
  if (!val) {
    return val;
  }
  const vx = val.split("-");
...
const groupBy = (data, key) => {
  return _.chain(data).groupBy(key).map((value, key2) => ({ key: key2, data: value })).value();
};
const sortByKey = (arr, key, direction = "desc", keyType = "date") => {
  let firstVal = 1;
  let secondVal = -1;
  if (direction === "desc") {
    firstVal = -1;
...
const sortOrdersByKey = (arr, key, direction = "desc", keyType = "date") => {
  let firstVal = 1;
  let secondVal = -1;
  if (direction === "desc") {
    firstVal = -1;
...
const categoryDisplay = (cat, categories) => {
  const found = categories.find((o) => o.value === cat);
  return found ? found.label : "";
};
const categoryIcon = (cat, categories) => {
  const found = categories.find((o) => o.value === cat);
  return found ? found.icon : "";
};
const openMapLink = (address2, suburb, state, postcode, country, type = "google") => {
  let url;
  if (type === "google") {
  ...
  if (Platform.is.desktop) {
    url = url == null ? void 0 : url.replace("maps:", "https:");
  }
  window.open(url);
};
...
const arrayRange = (start, stop, step, ts = false) => Array.from(
...
export { dateTimeTz as A, fromNowTz as B, awsSesStatus as C, sortOrdersByKey as D, agreedTimes as E, nl2br as F, displayDateDay as G, cancelOrderReasons as H, changeOrderReasonsDelivery as I, changeOrderReasons as J, categoryDisplay as a, doNotify as b, confirmDelete as c, displayDateOrder as d, arrayRange as e, hourBookingOptions as f, hourAgreedDisplay as g, hourBookingDisplay as h, displayDateDue as i, openMapLink as j, currencyFormat as k, hourOptions as l, dayOptions as m, dayDisplay as n, orderColor as o, hourDisplay as p, durationDisplay as q, categoryIcon as r, sortByKey as s, groupBy as t, uploadConfig as u, dbDateDisplay as v, getTimeZones as w, getRowsPerPage as x, rowsPerPageOptions as y, setRowsPerPage as z };
