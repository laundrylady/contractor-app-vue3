import { c as commonjsGlobal, m as moment } from "./axios.ccd3a804.js";
import { bl as Notify, bm as Dialog } from "./index.e647c85a.js";
var lodash = { exports: {} };
/**
 * @license
...
const hourBookingDisplay = (val) => {
  var _a;
  return (_a = hourBookingOptions.find((o) => o.value === val)) == null ? void 0 : _a.label;
};
...
const dbDateDisplayDay = (val, format = "dddd") => {
  if (!val) {
    return;
  }
  return moment(val).format(format);
...
export { awsSesStatus as A, sortByKey as B, getDateRange as C, dbDate as D, dbDateDisplayDay as E, stateOptions as F, _, currencyFormat as a, doNotify as b, confirmDelete as c, dateTz as d, globalStatusList as e, dateTimeTz as f, groupBy as g, hourBookingOptions as h, displayDateDay as i, hourBookingDisplay as j, hourAgreedDisplay as k, fromNowTz as l, dayDisplay as m, hourDisplay as n, dbDateDisplay as o, hourOptions as p, categoryDisplay as q, dayOptions as r, durationDisplay as s, categoryIcon as t, uploadConfig as u, getTimeZones as v, valOrNs as w, getRowsPerPage as x, rowsPerPageOptions as y, setRowsPerPage as z };
