import { b as boot, u as useUserStore } from "./index.fbe50061.js";
...
var moment$2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": hooks
...
(function(module2) {
  ...
  (function(root, factory) {
    ...
    var VERSION = "0.5.40", zones2 = {}, links2 = {}, countries2 = {}, names = {}, guesses = {}, cachedGuess;
    ...
    function getZone(name2, caller) {
      ...
      if (links2[name2] && caller !== getZone && (link = getZone(links2[name2], getZone))) {
        zone = zones2[name2] = new Zone();
        zone._set(link);
    ...
    function tz(input) {
      var args = Array.prototype.slice.call(arguments, 0, -1), name2 = arguments[arguments.length - 1], zone = getZone(name2), out = moment2.utc.apply(null, args);
...
const api = axios$3.create({
  ...
  headers: {
    ...
    "If-Modified-Since": "0",
    Tz: sessionStorage.getItem("timezone") || moment$1.tz.guess()
  }
});
const userStore = useUserStore();
api.interceptors.response.use((response) => {
  userStore.setLastRequest(moment$1());
  return response;
});
var axios = boot(({ app }) => {
...
export { api as a, getDefaultExportFromCjs as b, commonjsGlobal as c, axios$1 as d, getAugmentedNamespace as g, hooks as h, moment$1 as m };
