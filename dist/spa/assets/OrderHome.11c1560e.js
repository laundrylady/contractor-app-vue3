...
import { _ as _sfc_main$2, Q as QDrawer } from "./MapWithMarker.23f3a529.js";
import { Q as QPage } from "./QPage.241a8b09.js";
import { Q as QLayout, a as QPageContainer } from "./QLayout.464685eb.js";
...
import { _ as _sfc_main$3 } from "./PostcodeRegionDisplay.8277f0f2.js";
import { _ as _sfc_main$1 } from "./StatusTag.3f4ee5b4.js";
import { _ as _sfc_main$4 } from "./GlobalNotes.d6330901.js";
import { u as useMixinDebug } from "./debug.972d445d.js";
import { f as displayDateOrder, h as hourBookingDisplay, A as fromNowTz } from "./help.f1ea19ef.js";
...
const _hoisted_17 = { class: "bg-white q-ma-sm rounded-borders" };
const _hoisted_18 = {
  key: 0,
  class: "text-right q-pa-sm"
};
const _hoisted_19 = { class: "q-pa-sm" };
const _hoisted_20 = ["href"];
const _hoisted_21 = { key: 0 };
const _hoisted_22 = { key: 1 };
const _hoisted_23 = { class: "q-mb-md q-mt-xl" };
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-xs" }, "Internal Customer Notes", -1);
                ...
                createBaseVNode("div", _hoisted_3, [
                  createBaseVNode("div", _hoisted_4, [
                        ...
                        createBaseVNode("div", null, [
                          ...
                          createBaseVNode("div", null, [
                            model.value.team.owing_no_booking || model.value.team.status === "blocked" ? (openBlock(), createBlock(QBadge, {
                              key: 0,
                              label: "Blocked from new bookings"
                            })) : createCommentVNode("", true)
                          ]),
                          model.value.recurring_order && model.value.scheduled_pickup_time ? (openBlock(), createElementBlock("div", _hoisted_13, [
                            createVNode(QBadge, {
                              class: "q-pa-sm",
                              color: "secondary"
                            }, {
                    ...
                    !unref($q).screen.xs ? (openBlock(), createElementBlock("div", _hoisted_14, [
                      ...
                      model.value.status === "cancelled" ? (openBlock(), createElementBlock("span", _hoisted_15, " by " + toDisplayString(model.value.cancel_by), 1)) : createCommentVNode("", true),
                      model.value.cancel_reason ? (openBlock(), createElementBlock("div", _hoisted_16, toDisplayString(model.value.cancel_reason), 1)) : createCommentVNode("", true),
                      createBaseVNode("div", null, [
          ...
          createVNode(QDrawer, {
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_17, [
                unref($q).screen.lt.lg ? (openBlock(), createElementBlock("div", _hoisted_18, [
                  ...
                  default: withCtx(() => [
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            createBaseVNode("a", {
                              ...
                              class: "link"
                            }, toDisplayString(model.value.team.mobile), 9, _hoisted_20)
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    createVNode(QItem, null, {
                      default: withCtx(() => [
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(model.value.team.payment_terms), 1)
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    createVNode(QItem, null, {
                      default: withCtx(() => [
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            model.value.scheduled_pickup_date ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString(unref(displayDateOrder)(model.value.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                            createTextVNode(),
                            model.value.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_22, "(" + toDisplayString(unref(hourBookingDisplay)(model.value.scheduled_pickup_time)) + ")", 1)) : createCommentVNode("", true)
                          ]),
                          _: 1
                        })
                      ]),
