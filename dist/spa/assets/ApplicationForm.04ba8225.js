...
const _hoisted_40 = /* @__PURE__ */ createBaseVNode("a", {
...
const _hoisted_42 = /* @__PURE__ */ createBaseVNode("a", {
  href: "https://www.ird.govt.nz/gst/registering-for-gst/register-for-gst",
  target: "_blank",
  class: "link"
}, "IRD GST Registration", -1);
const _hoisted_43 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Are you registered for GST?", -1);
...
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, "Commission will be paid to your nominated account. Please ensure this is completed or advised prior to any commission being due.", -1);
...
const _hoisted_55 = { class: "q-mt-sm" };
const _hoisted_56 = /* @__PURE__ */ createBaseVNode("p", null, "Please upload copies of the following documents.", -1);
const _hoisted_57 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs" }, "Copy of current Drivers Licence (front and back)", -1);
const _hoisted_58 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of current Medicare Card", -1);
const _hoisted_59 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of Certificate of Currency for Public Liability Insuranced ", -1);
...
const _hoisted_61 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "NDIS Workers Clearance Certificate", -1);
...
const _hoisted_67 = /* @__PURE__ */ createBaseVNode("p", { class: "text-caption" }, "Accepted file types: jpg, gif, png, pdf, Max. file size: 5 MB", -1);
const _hoisted_68 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm q-mt-sm" }, "Your Equipment", -1);
const _hoisted_69 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm" }, "Please check the following", -1);
const _hoisted_70 = { class: "q-mb-sm" };
const _hoisted_71 = { class: "q-mb-sm" };
const _hoisted_72 = { class: "q-mb-sm" };
const _hoisted_73 = { class: "q-mb-sm" };
const _hoisted_74 = { class: "q-mb-sm" };
const _hoisted_75 = { class: "q-mb-sm" };
const _hoisted_76 = { class: "row q-col-gutter-md q-mt-sm" };
const _hoisted_77 = { class: "col-xs-12 col-sm-6" };
const _hoisted_78 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant One Signature", -1);
const _hoisted_79 = { style: { "border": "1px solid #efefef" } };
const _hoisted_80 = { class: "col-xs-12 col-sm-6" };
const _hoisted_81 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant Two Signature", -1);
const _hoisted_82 = { style: { "border": "1px solid #efefef" } };
                        ...
                        default: withCtx(() => [
                          ...
                          createVNode(QStep, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                ((_a = unref(common)) == null ? void 0 : _a.operating_country) === "aud" ? (openBlock(), createElementBlock("p", _hoisted_39, [
                                  createTextVNode("If you do not have an ABN, you can register at: "),
                                  _hoisted_40
                                ])) : createCommentVNode("", true),
                                ((_b = unref(common)) == null ? void 0 : _b.operating_country) === "nzd" ? (openBlock(), createElementBlock("p", _hoisted_41, [
                                ...
                                ((_e = unref(common)) == null ? void 0 : _e.operating_country) === "aud" ? (openBlock(), createElementBlock("p", _hoisted_44, [
                                ...
                                ((_f = unref(common)) == null ? void 0 : _f.operating_country) === "nzd" ? (openBlock(), createElementBlock("p", _hoisted_46, [
