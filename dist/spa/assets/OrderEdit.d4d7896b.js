        ...
        createBaseVNode("div", _hoisted_1$2, [
          ...
          unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
            unref(localModel).total_price > 0 && unref(localModel).status !== "PAID" ? (openBlock(), createElementBlock("div", _hoisted_20$1, [
              ...
              createBaseVNode("a", {
                ...
                class: "link"
              }, "Click here to make a payment", 8, _hoisted_21$1)
            ])) : createCommentVNode("", true)
          ])) : createCommentVNode("", true),
          createVNode(QInput, {
            modelValue: unref(localModel).invoice_po,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(localModel).invoice_po = $event),
            ...
            append: withCtx(() => [
              createVNode(QBtn, {
                onClick: _cache[1] || (_cache[1] = ($event) => saveDetail()),
                label: "Save",
                color: "primary",
                size: "sm",
                rounded: ""
          ...
          createBaseVNode("div", _hoisted_22$1, [
            createBaseVNode("div", _hoisted_23$1, [
              createVNode(QBtn, {
                onClick: _cache[3] || (_cache[3] = ($event) => unref(openURL)(`/invoice/print/${unref(localModel).id}`)),
                icon: "picture_as_pdf",
              ...
              unref(canSend) ? (openBlock(), createBlock(QBtn, {
                key: 0,
                onClick: _cache[4] || (_cache[4] = ($event) => !unref(hasPickupNoShow) ? doSendPaymentRequest("sms") : sendPaymentRequestSms()),
                icon: "chat",
              ...
              unref(canEdit) && unref(localModel).status === "DRAFT" ? (openBlock(), createBlock(QBtn, {
                key: 1,
                onClick: _cache[5] || (_cache[5] = ($event) => deleteInvoice()),
