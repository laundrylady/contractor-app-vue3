...
const _hoisted_14$1 = { class: "text-h6" };
const _hoisted_15$1 = { key: 2 };
const _hoisted_16$1 = { key: 0 };
const _hoisted_17$1 = { class: "q-mt-md items-center q-pb-md" };
...
const _hoisted_23$1 = { class: "text-wrap" };
const _hoisted_24$1 = { key: 0 };
const _hoisted_25$1 = { key: 0 };
const _hoisted_26$1 = /* @__PURE__ */ createBaseVNode("p", null, "Please confirm the scheduled delivery date & time below:", -1);
const _hoisted_27$1 = { class: "row q-col-gutter-md" };
        ...
        createBaseVNode("div", _hoisted_1$2, [
          ...
          unref(localModel).id ? (openBlock(), createElementBlock("div", _hoisted_11$1, [
            ...
            createBaseVNode("div", _hoisted_12$1, [
              ...
              createBaseVNode("div", null, [
                unref(localModel).sent_for_payment && unref(localModel).status !== "PAID" && unref(localModel).due_date ? (openBlock(), createElementBlock("span", _hoisted_13$1, " Due: " + toDisplayString(unref(localModel).due_date), 1)) : createCommentVNode("", true),
                createBaseVNode("span", _hoisted_14$1, "Total: " + toDisplayString(unref(currencyFormat)(unref(localModel).grand_total_price)), 1)
              ])
            ])
          ])) : createCommentVNode("", true),
          unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_15$1, [
          ...
          createBaseVNode("div", _hoisted_17$1, [
            createBaseVNode("div", _hoisted_18$1, [
              createVNode(QBtn, {
                onClick: _cache[4] || (_cache[4] = ($event) => unref(openURL)(`/api/public/invoice/pdf/${unref(localModel).id}`)),
                icon: "picture_as_pdf",
            ...
            notificationHistory.value && notificationHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(notificationHistory.value, (n) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  n.subject === "Invoice Ready For Payment" ? (openBlock(), createElementBlock("span", _hoisted_20$1, "Sent for payment ")) : createCommentVNode("", true),
                  n.subject && n.subject.match("Reminder") ? (openBlock(), createElementBlock("span", _hoisted_21$1, "Payment reminder ")) : createCommentVNode("", true),
                  n.subject && !n.subject.match("Reminder") && n.subject !== "Invoice Ready For Payment" ? (openBlock(), createElementBlock("span", _hoisted_22$1, "Invoice emailed ")) : createCommentVNode("", true),
                  createTextVNode(" to "),
                  createBaseVNode("span", _hoisted_23$1, [
                    createTextVNode(toDisplayString(n.to), 1),
                    n.cc && n.cc.length ? (openBlock(), createElementBlock("span", _hoisted_24$1, [
            ...
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !unref(hasPickupNoShow) ? (openBlock(), createElementBlock("div", _hoisted_25$1, [
                      _hoisted_26$1,
...
const _hoisted_75 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP DATE", -1);
const _hoisted_76 = { class: "col-xs-12 col-sm-6" };
const _hoisted_77 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP TIME", -1);
...
const _hoisted_81 = { class: "col-xs-12 col-sm-6" };
const _hoisted_82 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY DATE", -1);
const _hoisted_83 = { class: "col-xs-12 col-sm-6" };
const _hoisted_84 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY TIME", -1);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[53] || (_cache[53] = ($event) => showChangesOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !__props.model.scheduled_delivery_date ? (openBlock(), createElementBlock("div", _hoisted_73, [
                      ...
                      createBaseVNode("div", _hoisted_76, [
                        _hoisted_77,
                        !changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_78, toDisplayString(unref(hourBookingDisplay)(changes.value.time_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_79, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_time_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    __props.model.scheduled_delivery_date || __props.model.scheduled_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_80, [
                      ...
                      createBaseVNode("div", _hoisted_83, [
                        _hoisted_84,
                        !changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_85, toDisplayString(unref(hourBookingDisplay)(changes.value.timeDelivery_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_86, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_timeDelivery_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    createVNode(QSelect, {
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[52] || (_cache[52] = ($event) => doSave()),
