...
const _hoisted_17 = { class: "text-h7 q-mt-xs" };
const _hoisted_18 = {
  key: 1,
  style: { "border": "#cf1677 1px dashed" }
};
const _hoisted_19 = { class: "flex no-wrap" };
...
const _hoisted_28 = { class: "q-ml-xs text-right" };
const _hoisted_29 = {
  key: 0,
  class: "q-mb-xs"
};
const _hoisted_30 = { class: "text-h7 q-mt-xs" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
              ...
              return openBlock(), createBlock(QItem, {
                ...
                default: withCtx(() => [
                        ...
                        createBaseVNode("div", null, [
                          ...
                          createBaseVNode("div", null, [
                            o.status !== "ready_for_delivery" ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                o.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_7, toDisplayString(unref(displayDateDay)(o.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                            ...
                            o.status === "ready_for_delivery" && o.scheduled_delivery_date ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                o.scheduled_delivery_date ? (openBlock(), createElementBlock("span", _hoisted_10, toDisplayString(unref(displayDateDay)(o.scheduled_delivery_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" " + toDisplayString(o.scheduled_delivery_date) + " (", 1),
                            ...
                            createBaseVNode("div", null, [
                              ...
                              o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_14, [
                  ...
                  o.grand_total_price > 0 ? (openBlock(), createBlock(QItemSection, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_17, toDisplayString(unref(currencyFormat)(o.grand_total_price)), 1)
                    ]),
                    _: 2
                  }, 1024)) : createCommentVNode("", true)
                ]),
        ...
        reorder.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
              ...
              createVNode(QItem, {
                ...
                default: withCtx(() => [
                  ...
                  createVNode(QItemSection, null, {
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_19, [
                        createBaseVNode("div", null, [
                          createBaseVNode("div", null, [
                            __props.bookingId ? (openBlock(), createElementBlock("div", _hoisted_20, " Booking: #" + toDisplayString(element.display_id), 1)) : createCommentVNode("", true),
                            element.status !== "ready_for_delivery" ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                element.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(unref(displayDateDay)(element.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" " + toDisplayString(element.scheduled_pickup_date) + " (", 1),
                                !element.agreed_pickup_time && element.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString(unref(hourBookingDisplay)(element.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                                element.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_23, toDisplayString(unref(hourAgreedDisplay)(element.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                                createTextVNode(")")
                              ]),
                              _: 2
                            }, 1032, ["to"])) : createCommentVNode("", true),
                            element.status === "ready_for_delivery" && element.scheduled_delivery_date && (element.agreed_pickup_time || element.scheduled_pickup_time) ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                element.scheduled_delivery_date ? (openBlock(), createElementBlock("span", _hoisted_24, toDisplayString(unref(displayDateDay)(element.scheduled_delivery_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" " + toDisplayString(element.scheduled_delivery_date) + " (", 1),
                                !element.agreed_delivery_time && element.scheduled_delivery_time ? (openBlock(), createElementBlock("span", _hoisted_25, toDisplayString(unref(hourBookingDisplay)(element.scheduled_delivery_time)), 1)) : createCommentVNode("", true),
                                element.agreed_delivery_time ? (openBlock(), createElementBlock("span", _hoisted_26, toDisplayString(unref(hourAgreedDisplay)(element.agreed_delivery_time)), 1)) : createCommentVNode("", true),
                                createTextVNode(")")
                              ]),
                              _: 2
                            }, 1032, ["to"])) : createCommentVNode("", true)
                          ...
                          createBaseVNode("div", null, [
                            ...
                            element.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_27, toDisplayString(element.team.suburbpostcoderegion.locality), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode(QSpace),
                        createBaseVNode("div", _hoisted_28, [
                          __props.status ? (openBlock(), createElementBlock("div", _hoisted_29, [
                            createVNode(_sfc_main$3, {
                  ...
                  element.grand_total_price > 0 ? (openBlock(), createBlock(QItemSection, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_30, toDisplayString(unref(currencyFormat)(element.grand_total_price)), 1)
                    ]),
                    _: 2
                  }, 1024)) : createCommentVNode("", true)
                ]),
