...
const _hoisted_43 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey q-mb-sm" }, "PREMISES ADDRESS", -1);
const _hoisted_44 = { class: "row q-col-gutter-md q-mb-md" };
const _hoisted_45 = { class: "col-xs-12 col-sm-6" };
const _hoisted_46 = { class: "col-xs-12 col-sm-6" };
const _hoisted_47 = { key: 1 };
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("p", null, "Enter the name and email address of the person that will act as the guarantor when signing the agreement:", -1);
const _hoisted_49 = { class: "row q-col-gutter-md q-mb-sm" };
const _hoisted_50 = { class: "col-xs-12 col-sm-6" };
const _hoisted_51 = { class: "col-xs-12 col-sm-6" };
const _hoisted_52 = /* @__PURE__ */ createBaseVNode("p", null, "Enter the name and email address of the person that will act as the witness when signing the agreement:", -1);
const _hoisted_53 = { class: "row q-col-gutter-md q-mb-sm" };
...
const _hoisted_57 = /* @__PURE__ */ createBaseVNode("a", {
...
const _hoisted_60 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Are you registered for GST?", -1);
...
const _hoisted_64 = /* @__PURE__ */ createBaseVNode("a", {
  href: "https://www.ird.govt.nz/gst/registering-for-gst/register-for-gst",
  target: "_blank",
  class: "link"
}, "Click here for more information", -1);
const _hoisted_65 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, "Commission will be paid to your nominated account. Please ensure this is completed or advised prior to any commission being due.", -1);
const _hoisted_66 = { class: "row q-col-gutter-md" };
const _hoisted_67 = { class: "col-xs-12 col-sm-6" };
...
const _hoisted_72 = { class: "q-mt-sm" };
const _hoisted_73 = /* @__PURE__ */ createBaseVNode("p", null, "Please upload copies of the following documents.", -1);
const _hoisted_74 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs" }, "Copy of current Drivers Licence (front and back)", -1);
const _hoisted_75 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of current Medicare Card", -1);
const _hoisted_76 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of Certificate of Currency for Public Liability Insuranced ", -1);
...
const _hoisted_78 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "NDIS Workers Clearance Certificate", -1);
...
const _hoisted_84 = /* @__PURE__ */ createBaseVNode("p", { class: "text-caption" }, "Accepted file types: jpg, gif, png, pdf, Max. file size: 5 MB", -1);
const _hoisted_85 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm q-mt-sm" }, "Your Equipment", -1);
const _hoisted_86 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm" }, "Please check the following", -1);
const _hoisted_87 = { class: "q-mb-sm" };
...
const _hoisted_93 = { class: "row q-col-gutter-md q-mt-sm" };
const _hoisted_94 = { class: "col-xs-12 col-sm-6" };
const _hoisted_95 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant One Signature", -1);
const _hoisted_96 = { style: { "border": "1px solid #efefef" } };
const _hoisted_97 = { class: "col-xs-12 col-sm-6" };
const _hoisted_98 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant Two Signature", -1);
const _hoisted_99 = { style: { "border": "1px solid #efefef" } };
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                ...
                                ((_a = unref(common)) == null ? void 0 : _a.operating_country) === "nzd" ? (openBlock(), createElementBlock("div", _hoisted_39, [
                                  ...
                                  model.contractor_type === "company" ? (openBlock(), createElementBlock("div", _hoisted_47, [
                                    _hoisted_48,
                                ...
                                ((_b = unref(common)) == null ? void 0 : _b.operating_country) === "aud" ? (openBlock(), createElementBlock("p", _hoisted_56, [
                                  createTextVNode("If you do not have an ABN, you can register at: "),
                                  _hoisted_57
                                ])) : createCommentVNode("", true),
                                ((_c = unref(common)) == null ? void 0 : _c.operating_country) === "nzd" ? (openBlock(), createElementBlock("p", _hoisted_58, [
                                ...
                                ((_f = unref(common)) == null ? void 0 : _f.operating_country) === "aud" ? (openBlock(), createElementBlock("p", _hoisted_61, [
                                ...
                                ((_g = unref(common)) == null ? void 0 : _g.operating_country) === "nzd" ? (openBlock(), createElementBlock("p", _hoisted_63, [
