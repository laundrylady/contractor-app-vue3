    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        __props.o.productcategories ? (openBlock(), createElementBlock("span", _hoisted_1$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.o.productcategories.filter((q) => q.meta && q.meta.pivot_active), (c, index2) => {
            return openBlock(), createElementBlock("span", {
              key: c.id
            }, [
              createTextVNode(toDisplayString(c.name), 1),
              index2 + 1 !== __props.o.productcategories.filter((q) => q.meta && q.meta.pivot_active).length ? (openBlock(), createElementBlock("span", _hoisted_2$1, "&")) : createCommentVNode("", true)
            ]);
          }), 128)),
...
const _hoisted_9 = { class: "text-grey-7" };
const _hoisted_10 = { class: "text-grey-7" };
const _hoisted_11 = {
  key: 0,
  class: "q-mr-sm"
};
const _hoisted_12 = { class: "q-ml-xs text-right" };
const _hoisted_13 = {
  key: 0,
  class: "q-mb-xs"
};
...
const _hoisted_22 = { class: "text-grey-7" };
const _hoisted_23 = { class: "text-grey-7" };
const _hoisted_24 = {
  key: 0,
  class: "q-mr-sm"
};
...
const _hoisted_28 = { class: "text-h7 q-mt-xs" };
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          ...
          __props.orders.length && __props.optimal ? (openBlock(), createElementBlock("div", _hoisted_3, [
            createVNode(QBtn, {
              onClick: _cache[0] || (_cache[0] = ($event) => optimalRoute()),
              color: "primary",
              flat: "",
              "no-caps": "",
              label: "Optimal Route"
                      ...
                      createBaseVNode("div", _hoisted_4, [
                        createBaseVNode("div", null, [
                          ...
                          createBaseVNode("div", _hoisted_10, [
                            ...
                            createTextVNode(),
                            o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_11, toDisplayString(o.team.suburbpostcoderegion.locality) + " " + toDisplayString(o.team.suburbpostcoderegion.state), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode(QSpace),
                        createBaseVNode("div", _hoisted_12, [
                          __props.status ? (openBlock(), createElementBlock("div", _hoisted_13, [
        ...
        reorder.value ? (openBlock(), createElementBlock("div", _hoisted_16, [
          createVNode(unref(draggable), {
            ...
            item: withCtx(({ element, index: index2 }) => [
              createVNode(QItem, {
                class: normalizeClass({ "bg-white": !_ctx.$q.dark.isActive && (index2 === 0 || index2 % 2 === 0), "bg-grey-1": !_ctx.$q.dark.isActive && (index2 !== 0 && index2 % 2 !== 0) })
              }, {
                default: withCtx(() => [
                  ...
                  createVNode(QItemSection, null, {
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_17, [
                        createBaseVNode("div", null, [
                          createBaseVNode("div", null, [
                            __props.bookingId ? (openBlock(), createElementBlock("div", _hoisted_18, " Booking: #" + toDisplayString(element.display_id), 1)) : createCommentVNode("", true),
                            createVNode(_component_router_link, {
                              to: { name: "order-edit", params: { id: element.id } },
                              class: "link"
                            }, {
                              default: withCtx(() => [
                                element.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_19, toDisplayString(unref(displayDateDay)(element.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" " + toDisplayString(element.scheduled_pickup_date) + " (", 1),
                                !element.agreed_pickup_time && element.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_20, toDisplayString(unref(hourBookingDisplay)(element.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                                element.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(unref(hourAgreedDisplay)(element.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                                createTextVNode(")")
                              ]),
                              _: 2
                            }, 1032, ["to"])
                          ...
                          createBaseVNode("div", _hoisted_23, [
                            ...
                            createTextVNode(),
                            element.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_24, toDisplayString(element.suburbpostcoderegion.locality) + " " + toDisplayString(element.suburbpostcoderegion.state), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode(QSpace),
                        createBaseVNode("div", _hoisted_25, [
                          ...
                          createBaseVNode("div", _hoisted_27, [
                                ...
                                createVNode(QMenu, null, {
                                  default: withCtx(() => [
                                    createVNode(QList, null, {
                                      default: withCtx(() => [
                                        createVNode(QItem, {
                                          onClick: ($event) => unref(openMapLink)(element.lat, element.lng, "google"),
                                          clickable: ""
                                        }, {
                                          default: withCtx(() => [
                                            createVNode(QItemSection, null, {
                                        ...
                                        createVNode(QItem, {
                                          onClick: ($event) => unref(openMapLink)(element.lat, element.lng, "apple"),
                                          clickable: ""
                                        }, {
                                          default: withCtx(() => [
                                            createVNode(QItemSection, null, {
                            ...
                            element.status === "confirmed" ? (openBlock(), createBlock(QBtn, {
                              key: 0,
                              onClick: ($event) => onMyWay(element),
                              color: "primary",
                              round: "",
                              dense: "",
                              icon: "directions_car",
                            ...
                            element.status === "ready_for_delivery" ? (openBlock(), createBlock(QBtn, {
                              key: 1,
                              onClick: ($event) => completeOrder(element),
                              color: "primary",
                              round: "",
                              dense: "",
                              icon: "task_alt",
                  ...
                  element.grand_total_price > 0 ? (openBlock(), createBlock(QItemSection, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_28, toDisplayString(unref(currencyFormat)(element.grand_total_price)), 1)
                    ]),
                    _: 2
                  }, 1024)) : createCommentVNode("", true)
                ]),
