import { A as defineComponent, r as ref, I as useRouter, f as computed, o as onMounted, bw as resolveComponent, l as openBlock, J as createBlock, K as withCtx, s as normalizeClass, k as createVNode, N as QIcon, y as createCommentVNode, p as createBaseVNode, m as createElementBlock, aH as toDisplayString, R as unref, P as QBtn, F as Fragment, bd as renderList, Q as QCard, q as normalizeStyle } from "./index.068b7692.js";
...
import { h as hooks, a as api } from "./axios.d4b36dc3.js";
import { u as useMixinDebug } from "./debug.ffa51329.js";
import { h as hourBookingDisplay } from "./help.cbf54abd.js";
...
const _hoisted_16 = { class: "text-bold" };
const _hoisted_17 = { class: "flex" };
const _hoisted_18 = { key: 0 };
const _hoisted_19 = { class: "q-ml-sm" };
                        ...
                        hasEvents(scope.timestamp) ? (openBlock(), createElementBlock("div", _hoisted_9, [
                          (openBlock(true), createElementBlock(Fragment, null, renderList(getEvents(scope.timestamp), (event) => {
                            return openBlock(), createElementBlock("div", {
                              key: event.id,
                              class: normalizeClass(["q-pa-sm full-width q-mb-xs cursor-pointer", eventColor(event)]),
                              ...
                              createBaseVNode("div", _hoisted_11, toDisplayString(event.team.name), 1),
                              createBaseVNode("div", _hoisted_12, [
                                event.suburbpostcoderegion ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString(event.suburbpostcoderegion.locality), 1)) : createCommentVNode("", true),
                                createVNode(QSpace),
                    ...
                    "day-body": withCtx(({ scope: { timestamp, timeStartPos, timeDurationHeight } }) => [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(getWeekEvents(timestamp.date), (event, index) => {
                        return openBlock(), createElementBlock("div", {
                          key: event.id,
                          onClick: ($event) => orderNav(event.id),
                          class: normalizeClass(["q-pa-sm q-mb-xs order-event full-width", eventColor(event)]),
                          style: normalizeStyle([{ "font-size": "11px" }, badgeStyles(event, timeStartPos, timeDurationHeight, index)])
                        }, [
                          createBaseVNode("div", null, toDisplayString(unref(hourBookingDisplay)(event.scheduled_pickup_time)), 1),
                          createBaseVNode("div", _hoisted_16, toDisplayString(event.team.name), 1),
                          createBaseVNode("div", _hoisted_17, [
                            event.suburbpostcoderegion ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString(event.suburbpostcoderegion.locality), 1)) : createCommentVNode("", true),
                            createVNode(QSpace),
