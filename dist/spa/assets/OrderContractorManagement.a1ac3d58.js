...
import { A as defineComponent, r as ref, o as onMounted, w as watch, l as openBlock, m as createElementBlock, J as createBlock, y as createCommentVNode, F as Fragment, bd as renderList, p as createBaseVNode, aH as toDisplayString, k as createVNode, K as withCtx, s as normalizeClass, bs as QRadio, R as unref, P as QBtn } from "./index.068b7692.js";
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(c.data, (d) => {
                    return openBlock(), createBlock(QItem, {
                      key: d.id,
                      class: normalizeClass({ "bg-pink-1": d.user.id === tmpContractorUserId.value })
                    }, {
                      default: withCtx(() => [
