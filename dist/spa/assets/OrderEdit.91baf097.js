...
import { b7 as addFocusout, b9 as removeFocusout, C as defineComponent, r as ref, g as computed, i as inject, D as reactive, o as onMounted, m as openBlock, n as createElementBlock, q as createBaseVNode, F as Fragment, ab as renderList, t as normalizeClass, ac as createTextVNode, ad as toDisplayString, R as unref, z as createCommentVNode, l as createVNode, bk as createSlots, K as withCtx, P as QBtn, M as QInput, N as QIcon, aa as createBlock, H as withDirectives, bz as QSeparator, Q as QCard, L as QCardSection, ae as QCardActions, af as QDialog, G as onBeforeUnmount, aN as resolveComponent, bl as QCheckbox, as as QToggle } from "./index.f0bcd142.js";
...
import { a as QItem, Q as QItemSection } from "./selection.07b4b8ad.js";
import { Q as QList } from "./QList.cff4e2be.js";
import { Q as QItemLabel } from "./QItemLabel.2a9c8bab.js";
...
import { u as useVuelidate, r as required, a as requiredIf } from "./index.esm.15182dbd.js";
import { a as api } from "./axios.c33bd943.js";
import { _ as _sfc_main$9 } from "./AuditTimeline.8d3bb618.js";
import { _ as _sfc_main$6, a as _sfc_main$7, b as _sfc_main$8 } from "./PostcodeRegionField.e933c4a9.js";
import { _ as _sfc_main$4 } from "./DateField.89eba63d.js";
import { Q as QMenu } from "./QMenu.7752fb6c.js";
import { o as openURL } from "./open-url.8fb9519c.js";
import { u as useMixinDebug } from "./debug.b9d7424b.js";
import { t as groupBy, k as currencyFormat, A as dateTimeTz, f as hourBookingOptions, b as doNotify, c as confirmDelete, C as awsSesStatus, x as getRowsPerPage, y as rowsPerPageOptions, B as fromNowTz, z as setRowsPerPage, e as arrayRange, h as hourBookingDisplay, E as agreedTimes, g as hourAgreedDisplay, F as nl2br, G as displayDateDay, H as cancelOrderReasons, I as changeOrderReasonsDelivery, J as changeOrderReasons } from "./help.31050a33.js";
import { u as useMixinSecurity } from "./security.83ab89bc.js";
import { _ as _sfc_main$5 } from "./GlobalNotes.1b40dfd1.js";
import { Q as QTd } from "./QTd.d67efcc3.js";
import { Q as QTable } from "./QTable.4f4476ce.js";
import { p as productCategoriesVisibleBooking } from "./helpers.07c3f480.js";
...
const _hoisted_9$1 = { class: "text-h6 q-pa-sm bg-grey-2" };
const _hoisted_10$1 = { class: "text-primary" };
const _hoisted_11$1 = { class: "text-grey" };
const _hoisted_12$1 = { key: 2 };
const _hoisted_13$1 = { class: "flex items-start" };
const _hoisted_14$1 = { class: "text-right col-grow" };
const _hoisted_15$1 = { key: 0 };
const _hoisted_16$1 = {
  key: 0,
  class: "text-grey q-mr-sm"
};
const _hoisted_17$1 = { class: "text-h6" };
const _hoisted_18$1 = {
  key: 1,
...
const _hoisted_22$1 = { class: "q-mt-md items-center q-pb-md" };
const _hoisted_23$1 = { class: "flex" };
const _hoisted_24$1 = { key: 0 };
const _hoisted_25$1 = { key: 0 };
const _hoisted_26$1 = { key: 1 };
const _hoisted_27$1 = { key: 2 };
const _hoisted_28$1 = { class: "text-wrap" };
...
const _hoisted_35$1 = /* @__PURE__ */ createBaseVNode("p", null, "Please confirm the scheduled delivery date & time below:", -1);
const _hoisted_36$1 = { class: "row q-col-gutter-md" };
const _hoisted_37$1 = { class: "col-xs-12 col-sm-6" };
const _hoisted_38$1 = { class: "col-xs-12 col-sm-6" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(localModel).products.filter((o) => o.name !== "Service Fee" && o.name !== "Rounding"), (p, index) => {
              ...
              createBaseVNode("div", _hoisted_2$2, [
                createBaseVNode("div", null, [
                  ...
                  createBaseVNode("div", null, [
                    ...
                    p.id && nonEditableProducts.value.indexOf(p.product_id) === -1 && nonEditableProductCategories.value.indexOf(p.product.product_category_id) === -1 && unref(canEdit) && p.product_id !== 26 ? (openBlock(), createElementBlock("a", {
                      key: 0,
                      onClick: ($event) => removeProduct(p.id),
          ...
          unref(localModel).id && !unref(canSend) && unref(localModel).status !== "PAID" && unref(localModel).sent_for_payment ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
            createVNode(QIcon, {
              name: "warning",
              size: "16px"
            }),
            createTextVNode(" This invoice has been issued for payment and cannot be edited due to the customer type. Please contact Support for any required changes. ")
          ])) : createCommentVNode("", true),
          unref(localModel).id && unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
                                ...
                                return withDirectives((openBlock(), createBlock(QItem, {
                                  ...
                                  default: withCtx(() => [
                                    createVNode(QItemSection, null, {
                                      default: withCtx(() => [
                                        createBaseVNode("div", _hoisted_10$1, toDisplayString(d.name), 1),
                                        createBaseVNode("div", _hoisted_11$1, toDisplayString(unref(currencyFormat)(d.unit_price)) + " per " + toDisplayString(d.unit_measurement), 1)
                                      ]),
                                      _: 2
                                    }, 1024)
                                  ]),
          ...
          unref(localModel).id ? (openBlock(), createElementBlock("div", _hoisted_12$1, [
            createVNode(QSeparator, { class: "q-mb-sm" }),
            createBaseVNode("div", _hoisted_13$1, [
              unref(localModel).products && unref(localModel).products.filter((o) => o.name !== "Service Fee").length && unref(canEdit) ? (openBlock(), createBlock(QBtn, {
                key: 0,
                onClick: _cache[0] || (_cache[0] = ($event) => clearProducts()),
                label: "RESET Services",
                color: "negative",
                flat: "",
                rounded: "",
              ...
              createBaseVNode("div", _hoisted_14$1, [
                createBaseVNode("div", null, "Subtotal: " + toDisplayString(unref(currencyFormat)(unref(serviceFeeOther) ? unref(serviceFee) ? unref(localModel).total_price - unref(serviceFee).price : unref(localModel).total_price : 0)), 1),
                unref(serviceFee) && unref(serviceFeeOther) ? (openBlock(), createElementBlock("div", _hoisted_15$1, "Service Fee: " + toDisplayString(unref(currencyFormat)(unref(serviceFee).price)), 1)) : createCommentVNode("", true),
                ...
                createBaseVNode("div", null, [
                  unref(localModel).sent_for_payment && unref(localModel).status !== "PAID" && unref(localModel).due_date ? (openBlock(), createElementBlock("span", _hoisted_16$1, " Due: " + toDisplayString(unref(localModel).due_date), 1)) : createCommentVNode("", true),
                  createBaseVNode("span", _hoisted_17$1, "Total: " + toDisplayString(unref(currencyFormat)(unref(serviceFeeOther) ? unref(localModel).grand_total_price : 0)), 1)
                ]),
                unref(localModel).status === "AUTHORISED" && owing.value.owing > 0 ? (openBlock(), createElementBlock("div", _hoisted_18$1, " Amount Due: " + toDisplayString(unref(currencyFormat)(owing.value.owing)), 1)) : createCommentVNode("", true)
              ])
            ])
          ])) : createCommentVNode("", true),
          unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
            unref(localModel).total_price > 0 && unref(localModel).status !== "PAID" ? (openBlock(), createElementBlock("div", _hoisted_20$1, [
              createTextVNode(" Payment link: "),
              createBaseVNode("a", {
                href: `/payments/session/${unref(localModel).id}`,
                class: "link",
                target: "_blank"
              }, "Click here to view the online payment link.", 8, _hoisted_21$1),
              createTextVNode(),
              createVNode(QBtn, {
                flat: "",
                round: "",
                onClick: _cache[1] || (_cache[1] = ($event) => copyPaymentLinkUrl()),
                color: "grey",
                icon: "content_copy",
                size: "sm",
          ...
          createVNode(QInput, {
            ...
            append: withCtx(() => [
              createVNode(QBtn, {
                onClick: _cache[2] || (_cache[2] = ($event) => saveDetail()),
                label: "Save",
                color: "primary",
                size: "sm",
                rounded: ""
          ...
          createBaseVNode("div", _hoisted_22$1, [
            createBaseVNode("div", _hoisted_23$1, [
              ...
              unref(canEdit) && unref(localModel).status === "DRAFT" ? (openBlock(), createBlock(QBtn, {
                key: 1,
                onClick: _cache[6] || (_cache[6] = ($event) => deleteInvoice()),
              ...
              unref(canSend) ? (openBlock(), createBlock(QBtn, {
                key: 2,
                onClick: _cache[7] || (_cache[7] = ($event) => doSendPaymentRequest("email")),
                icon: "mail",
            ...
            notificationHistory.value && notificationHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(notificationHistory.value, (n) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  n.subject && n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_25$1, "Sent for payment ")) : createCommentVNode("", true),
                  n.subject && n.subject.match("reminder") ? (openBlock(), createElementBlock("span", _hoisted_26$1, "Payment reminder ")) : createCommentVNode("", true),
                  n.subject && !n.subject.match("reminder") && !n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_27$1, "Invoice emailed ")) : createCommentVNode("", true),
                  createTextVNode(" to "),
                  createBaseVNode("span", _hoisted_28$1, [
                    createTextVNode(toDisplayString(n.to), 1),
                    n.cc && n.cc.length ? (openBlock(), createElementBlock("span", _hoisted_29$1, [
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => sendPaymentModal.value.show = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !unref(hasPickupNoShow) ? (openBlock(), createElementBlock("div", _hoisted_30$1, [
                      _hoisted_31$1,
                      createBaseVNode("div", _hoisted_32$1, [
                        createBaseVNode("div", _hoisted_33$1, [
                          createVNode(_sfc_main$4, {
                            modelValue: sendPaymentModal.value.scheduled_delivery_date,
                            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => sendPaymentModal.value.scheduled_delivery_date = $event),
                        ...
                        createBaseVNode("div", _hoisted_34$1, [
                          createVNode(QSelect, {
                            ...
                            "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => sendPaymentModal.value.scheduled_delivery_time = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => sendPaymentModal.value.content = $event),
                      type: "textarea",
                      outlined: "",
                      rows: "3",
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[11] || (_cache[11] = ($event) => sendPaymentRequest()),
                      color: "primary",
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => sendPaymentModalSms.value.show = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_36$1, [
                      createBaseVNode("div", _hoisted_37$1, [
                        createVNode(_sfc_main$4, {
                          ...
                          "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => sendPaymentModalSms.value.scheduled_delivery_date = $event),
                          label: "Scheduled delivery date",
                          outlined: true,
                      ...
                      createBaseVNode("div", _hoisted_38$1, [
                        createVNode(QSelect, {
                          ...
                          "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => sendPaymentModalSms.value.scheduled_delivery_time = $event),
                          label: "Scheduled delivery time",
                          outlined: true,
                          options: unref(hourBookingOptions),
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[15] || (_cache[15] = ($event) => sendPaymentRequestSms()),
                      color: "primary",
                      label: "Send via SMS",
                      rounded: "",
...
const _hoisted_37 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold text-grey q-mt-md" }, "SERVICES", -1);
const _hoisted_38 = {
  key: 2,
...
const _hoisted_41 = { class: "q-mb-md" };
const _hoisted_42 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_43 = { class: "row q-col-gutter-md" };
const _hoisted_44 = { class: "col-xs-12 col-sm-6 col-lg-3" };
const _hoisted_45 = {
  key: 0,
...
const _hoisted_47 = /* @__PURE__ */ createBaseVNode("p", null, "If the booking needs to occur multiple times a week, choose the days below:", -1);
const _hoisted_48 = {
  key: 1,
  class: "row q-col-gutter-md"
};
const _hoisted_49 = { class: "col-xs-12 col-sm-6 col-lg-3" };
const _hoisted_50 = { class: "col-xs-12 col-sm-6 col-lg-4" };
const _hoisted_51 = {
  key: 4,
  class: "q-mt-md"
};
const _hoisted_52 = { class: "row q-col-gutter-md" };
const _hoisted_53 = { class: "col-xs-12 col-sm-6 col-lg-3" };
const _hoisted_54 = {
  key: 0,
  class: "col-xs-12 col-sm-6 col-lg-4"
};
...
const _hoisted_56 = /* @__PURE__ */ createBaseVNode("p", null, "If the booking needs to occur multiple times a week, choose the days below:", -1);
const _hoisted_57 = {
  key: 1,
  class: "row q-col-gutter-md"
};
const _hoisted_58 = { class: "col-xs-12 col-sm-6 col-lg-3" };
const _hoisted_59 = { class: "col-xs-12 col-sm-6 col-lg-4" };
const _hoisted_60 = {
  key: 0,
  class: "flex"
};
...
const _hoisted_78 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP DATE", -1);
const _hoisted_79 = { class: "col-xs-12 col-sm-6" };
const _hoisted_80 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "PICKUP TIME", -1);
...
const _hoisted_85 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY DATE", -1);
const _hoisted_86 = { class: "col-xs-12 col-sm-6" };
const _hoisted_87 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold" }, "DELIVERY TIME", -1);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const save = () => {
      if (changes.value.date_model !== localModel.value.scheduled_pickup_date || changes.value.time_model !== localModel.value.scheduled_pickup_time || changes.value.agreed_time_model !== localModel.value.agreed_pickup_time || changes.value.dateDelivery_model !== localModel.value.scheduled_delivery_date || changes.value.timeDelivery_model !== localModel.value.scheduled_delivery_time || changes.value.agreed_timeDelivery_model !== localModel.value.agreed_delivery_time || changes.value.productcategories !== JSON.stringify(localModel.value.productcategories.map((o) => {
        return { id: o.id, active: o.meta.pivot_active };
      }))) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
                          ...
                          default: withCtx(() => {
                            ...
                            return [
                              ...
                              bookingTab.value === "details" ? (openBlock(), createElementBlock("div", _hoisted_1, [
                                ...
                                unref(localModel).recurring_notes ? (openBlock(), createElementBlock("div", _hoisted_38, [
                                  createBaseVNode("div", _hoisted_39, [
                                    createVNode(QIcon, { name: "warning" }),
                                    createTextVNode(" Recurring notes: ")
                                  ]),
                                  createTextVNode(" " + toDisplayString(unref(nl2br)(unref(localModel).recurring_notes)), 1)
                                ])) : createCommentVNode("", true),
                                unref(localModel).recurring_parent_id && recurringModel.value ? (openBlock(), createElementBlock("div", _hoisted_40, [
                                  recurringModel.value.recurring_order ? (openBlock(), createElementBlock("div", {
                                    ...
                                    createBaseVNode("div", _hoisted_43, [
                                      ...
                                      recurringModel.value.recurring ? (openBlock(), createElementBlock("div", _hoisted_45, [
                                        createVNode(QSelect, {
                                    ...
                                    recurringModel.value.recurring === "Week" ? (openBlock(), createElementBlock("div", _hoisted_46, [
                                      _hoisted_47,
                                    ...
                                    recurringModel.value.recurring ? (openBlock(), createElementBlock("div", _hoisted_48, [
                                ...
                                !unref(localModel).recurring_parent_id ? (openBlock(), createElementBlock("div", _hoisted_51, [
                                  createVNode(QToggle, {
                                  ...
                                  unref(localModel).recurring_order ? (openBlock(), createElementBlock("div", {
                                    ...
                                    createBaseVNode("div", _hoisted_52, [
                                      ...
                                      __props.model.recurring ? (openBlock(), createElementBlock("div", _hoisted_54, [
                                        createVNode(QSelect, {
                                    ...
                                    unref(localModel).recurring === "Week" ? (openBlock(), createElementBlock("div", _hoisted_55, [
                                      _hoisted_56,
                                    ...
                                    __props.model.recurring ? (openBlock(), createElementBlock("div", _hoisted_57, [
                          ...
                          default: withCtx(() => {
                            ...
                            return [
                              ...
                              ((_b = unref(user)) == null ? void 0 : _b.id) === unref(localModel).contractor_user_id ? (openBlock(), createBlock(QBtn, {
                                key: 2,
                                disable: loading.value || unref($v).$invalid || !unref(hasProductCategories),
                  ...
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                        !unref(localModel).invoice ? (openBlock(), createBlock(QCardSection, { key: 0 }, {
                          default: withCtx(() => {
                            ...
                            return [
                              ...
                              unref(localModel).contractor_user_id === ((_a = unref(user)) == null ? void 0 : _a.id) ? (openBlock(), createElementBlock("div", _hoisted_60, [
                                createVNode(QBtn, {
                        ...
                        unref(localModel).invoice ? (openBlock(), createElementBlock("div", _hoisted_61, [
                          createVNode(QTabs, {
                          ...
                          invoiceTab.value === "notes" ? (openBlock(), createElementBlock("div", _hoisted_62, [
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("div", null, [
                          createVNode(_component_router_link, {
                            ...
                            default: withCtx(() => [
                              o.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_67, toDisplayString(unref(displayDateDay)(o.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                              createTextVNode(" " + toDisplayString(o.scheduled_pickup_date) + " (", 1),
                              !o.agreed_pickup_time && o.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_68, toDisplayString(unref(hourBookingDisplay)(o.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                              o.agreed_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_69, toDisplayString(unref(hourAgreedDisplay)(o.agreed_pickup_time)), 1)) : createCommentVNode("", true),
                              createTextVNode(")")
                            ]),
                            _: 2
                          }, 1032, ["to"])
                        ...
                        createBaseVNode("div", _hoisted_70, [
                          ...
                          createTextVNode(),
                          o.productcategories ? (openBlock(), createElementBlock("span", _hoisted_71, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(o.productcategories, (c, index) => {
                              return openBlock(), createElementBlock("span", {
                                ...
                                index + 1 !== o.productcategories.length ? (openBlock(), createElementBlock("span", _hoisted_72, "&")) : createCommentVNode("", true)
                              ]);
                            }), 128)),
                        ...
                        createBaseVNode("div", _hoisted_73, [
                          ...
                          createTextVNode(),
                          o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_74, toDisplayString(o.team.suburbpostcoderegion.locality) + " " + toDisplayString(o.team.suburbpostcoderegion.state), 1)) : createCommentVNode("", true)
                        ])
                      ])
                    ]),
                    _: 2
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[49] || (_cache[49] = ($event) => showCancelOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    ...
                    unref(localModel).recurring_order || unref(localModel).recurring_parent_id ? (openBlock(), createElementBlock("div", _hoisted_75, [
                      createVNode(QCheckbox, {
                        modelValue: unref(localModel).cancel_recurring,
                        "onUpdate:modelValue": _cache[47] || (_cache[47] = ($event) => unref(localModel).cancel_recurring = $event),
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[48] || (_cache[48] = ($event) => cancelOrder()),
          ...
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !__props.model.scheduled_delivery_date ? (openBlock(), createElementBlock("div", _hoisted_76, [
                      ...
                      createBaseVNode("div", _hoisted_79, [
                        _hoisted_80,
                        !changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_81, toDisplayString(unref(hourBookingDisplay)(changes.value.time_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_time_model ? (openBlock(), createElementBlock("div", _hoisted_82, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_time_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    __props.model.scheduled_delivery_date || __props.model.scheduled_delivery_time ? (openBlock(), createElementBlock("div", _hoisted_83, [
                      ...
                      createBaseVNode("div", _hoisted_86, [
                        _hoisted_87,
                        !changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_88, toDisplayString(unref(hourBookingDisplay)(changes.value.timeDelivery_model)), 1)) : createCommentVNode("", true),
                        changes.value.agreed_timeDelivery_model ? (openBlock(), createElementBlock("div", _hoisted_89, toDisplayString(unref(hourAgreedDisplay)(changes.value.agreed_timeDelivery_model)), 1)) : createCommentVNode("", true)
                      ])
                    ])) : createCommentVNode("", true),
                    createVNode(QSelect, {
                      modelValue: unref(localModel).changes_reason,
                      "onUpdate:modelValue": _cache[50] || (_cache[50] = ($event) => unref(localModel).changes_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[51] || (_cache[51] = ($event) => unref(localModel).changes_notes = $event),
                      label: "Extra notes for the customer",
                      type: "textarea",
                      rows: "3",
                      outlined: "",
                    ...
                    unref(localModel).recurring_parent_id ? (openBlock(), createElementBlock("div", _hoisted_90, [
                      createVNode(QCheckbox, {
                        modelValue: recurringChildChange.value,
                        "onUpdate:modelValue": _cache[52] || (_cache[52] = ($event) => recurringChildChange.value = $event),
