import { B as defineComponent, r as ref, J as useRouter, g as computed, o as onMounted, bx as resolveComponent, m as openBlock, K as createBlock, L as withCtx, t as normalizeClass, l as createVNode, O as QIcon, z as createCommentVNode, q as createBaseVNode, n as createElementBlock, aI as toDisplayString, S as unref, R as QBtn, Q as QCard, F as Fragment, be as renderList, bv as QSeparator, s as normalizeStyle, aj as createTextVNode, E as nextTick } from "./index.250db7cb.js";
import { a as QBreadcrumbs, Q as QBreadcrumbsEl } from "./QBreadcrumbs.4c9129f6.js";
...
import { t as today, Q as QCalendarMonth } from "./index.esm.72ddbcc5.js";
import { h as hooks, a as api } from "./axios.ffd1dad3.js";
import { u as useMixinDebug } from "./debug.972d445d.js";
import { l as dbDateDisplay, h as hourBookingDisplay, f as hourAgreedDisplay, y as sortOrdersByKey } from "./help.9c7320a1.js";
    ...
    const eventsMap = computed(() => {
      ...
      orders.value.forEach((order) => {
        ...
        if (order.scheduled_delivery_date) {
          ...
          order.deliverySortTime = timeStart2;
                          ...
                          (openBlock(true), createElementBlock(Fragment, null, renderList(getEvents(scope.timestamp), (event) => {
                            return openBlock(), createElementBlock("div", {
                              ...
                              createBaseVNode("div", _hoisted_12, [
                                event.scheduled_pickup_time && (unref(hooks)(scope.timestamp.date).isSame(unref(hooks)(event.scheduled_pickup_date, "DD/MM/YYYY")) || !event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_13, [
                                ...
                                event.scheduled_delivery_time && (unref(hooks)(scope.timestamp.date).isSame(unref(hooks)(event.scheduled_delivery_date, "DD/MM/YYYY")) && event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_16, [
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(getWeekEvents(timestamp.date), (event, index) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_24, [
                            event.scheduled_pickup_time && (unref(hooks)(timestamp.date).isSame(unref(hooks)(event.scheduled_pickup_date, "DD/MM/YYYY")) || !event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_25, [
                            ...
                            event.scheduled_delivery_time && (unref(hooks)(timestamp.date).isSame(unref(hooks)(event.scheduled_delivery_date, "DD/MM/YYYY")) && event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_28, [
                              !event.agreed_delivery_time ? (openBlock(), createElementBlock("span", _hoisted_29, [
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(getWeekEvents(timestamp.date), (event, index) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_36, [
                            event.scheduled_pickup_time && (unref(hooks)(timestamp.date).isSame(unref(hooks)(event.scheduled_pickup_date, "DD/MM/YYYY")) || !event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_37, [
                            ...
                            event.scheduled_delivery_time && (unref(hooks)(timestamp.date).isSame(unref(hooks)(event.scheduled_delivery_date, "DD/MM/YYYY")) && event.scheduled_pickup_date) ? (openBlock(), createElementBlock("div", _hoisted_40, [
