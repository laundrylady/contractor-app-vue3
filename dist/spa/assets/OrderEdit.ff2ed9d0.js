...
import { Q as QSelect } from "./QSelect.2ec92ecf.js";
import { S as createComponent, ab as useDarkProps, af as useFormProps, ac as useDark, bn as useFormAttrs, r as ref, f as computed, w as watch, D as nextTick, b0 as position, V as hSlot, h, g as getCurrentInstance, ah as useFormInject, bf as vmIsDestroyed, H as Transition, G as withDirectives, P as QBtn, A as defineComponent, i as inject, B as reactive, o as onMounted, l as openBlock, m as createElementBlock, F as Fragment, bd as renderList, s as normalizeClass, p as createBaseVNode, aG as createTextVNode, aH as toDisplayString, R as unref, y as createCommentVNode, k as createVNode, bG as createSlots, K as withCtx, M as QInput, bu as QSeparator, N as QIcon, J as createBlock, bv as resolveComponent, Q as QCard, L as QCardSection, ai as QToggle, aa as QCardActions, be as QCheckbox } from "./index.ef1b2cb4.js";
import { T as TouchPan } from "./TouchPan.201b3275.js";
import { u as useDatetimeProps, a as useDatetimeEmits, b as useDatetime, c as __splitDate, g as getDayHash, f as formatDate, _ as _sfc_main$4 } from "./DateField.aae0861f.js";
import { p as pad } from "./format.3e32b8d9.js";
import { Q as QExpansionItem } from "./QExpansionItem.9fafab09.js";
import { a as QItem, Q as QItemSection } from "./QItemSection.71b58638.js";
import { Q as QList } from "./QList.4bb90025.js";
import { Q as QItemLabel } from "./selection.bb98bc68.js";
import { Q as QSpace } from "./QSpace.998e19e0.js";
import { u as useVuelidate, r as required } from "./index.esm.af518789.js";
import { a as api } from "./axios.b301f987.js";
import { _ as _sfc_main$3 } from "./UserAvatar.5eb4d509.js";
import { _ as _sfc_main$8 } from "./AuditTimeline.783d6049.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./PostcodeRegionField.c8f1b987.js";
import { _ as _sfc_main$7 } from "./CountryField.9e2013c7.js";
import { Q as QMenu } from "./QMenu.9b70bf89.js";
...
import { q as groupBy, i as currencyFormat, t as dateTimeTz, c as confirmDelete, d as doNotify, h as hourBookingOptions, f as hourAgreedDisplay, b as displayDateDay, e as hourBookingDisplay } from "./help.470b0717.js";
import { _ as _sfc_main$2 } from "./GlobalNotes.25600a85.js";
import { _ as _sfc_main$9 } from "./GlobalNotifications.c7ab31ba.js";
import { u as useMixinSecurity } from "./security.51dc487e.js";
import { p as productCategoriesVisibleBooking } from "./helpers.52dfc6ae.js";
import { u as useI18n } from "./vue-i18n.runtime.esm-bundler.e59ea7e5.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_17$1, [
          ...
          createVNode(QSpace),
          createBaseVNode("div", null, [
            !unref(localModel).sent_for_payment ? (openBlock(), createBlock(QBtn, {
              key: 0,
              onClick: _cache[2] || (_cache[2] = ($event) => emailInvoice()),
              icon: "mail",
              title: "Email a copy of the Invoice",
              flat: "",
              disable: emailingInvoice.value,
              round: ""
            ...
            unref(localModel).total_price > 0 && !unref(localModel).sent_for_payment ? (openBlock(), createBlock(QBtn, {
              key: 1,
              onClick: _cache[3] || (_cache[3] = ($event) => sendPaymentRequest()),
              icon: "send",
            ...
            createVNode(QList, null, {
              default: withCtx(() => [
                createVNode(QExpansionItem, {
                  ...
                  onClick: _cache[9] || (_cache[9] = ($event) => bookingTab.value = "details")
                }, {
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                                ...
                                createBaseVNode("div", _hoisted_9, [
                                  createBaseVNode("div", _hoisted_10, [
                                    createVNode(_sfc_main$4, {
                                      ...
                                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(localModel).scheduled_pickup_date = $event),
                                    ...
                                    createVNode(QSelect, {
                                      ...
                                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(localModel).scheduled_pickup_time = $event),
                                  ...
                                  !unref(localModel).recurring_parent_id ? (openBlock(), createElementBlock("div", _hoisted_11, [
                                    createVNode(QToggle, {
                                      ...
                                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref(localModel).recurring_order = $event),
                                    ...
                                    unref(localModel).recurring_order ? (openBlock(), createBlock(QSelect, {
                                      ...
                                      "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => unref(localModel).recurring = $event),
                                ...
                                unref(canEdit) || unref(localModel).agreed_pickup_time ? (openBlock(), createElementBlock("div", _hoisted_16, [
                                  ...
                                  unref(localModel).agreed_pickup_time ? (openBlock(), createElementBlock("div", _hoisted_19, [
                                    ...
                                    unref(localModel).agreed_pickup_time && unref(canEdit) ? (openBlock(), createElementBlock("a", {
                                      key: 0,
                                      onClick: _cache[5] || (_cache[5] = ($event) => unref(localModel).agreed_pickup_time = null),
                                      class: "link q-ml-sm"
                                  ...
                                  unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_20, [
                                    createBaseVNode("div", null, [
                                      createBaseVNode("a", {
                                        onClick: _cache[6] || (_cache[6] = ($event) => showTimePicker.value = !showTimePicker.value),
                                        class: "link"
                                      }, "Choose a time")
                                    ]),
                ...
                createVNode(QExpansionItem, {
                  ...
                  "header-class": "text-h6",
                  "default-opened": "",
                  onClick: _cache[20] || (_cache[20] = ($event) => invoiceTab.value = "products")
                }, {
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                        !unref(localModel).invoice ? (openBlock(), createBlock(QCardSection, { key: 0 }, {
                          default: withCtx(() => [
                            ...
                            createVNode(QBtn, {
                              ...
                              onClick: _cache[10] || (_cache[10] = ($event) => createInvoice()),
                              color: "primary",
                              icon: "add_circle",
                              rounded: ""
                            })
                        ...
                        unref(localModel).invoice ? (openBlock(), createElementBlock("div", _hoisted_21, [
                          createVNode(QTabs, {
                            ...
                            "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => invoiceTab.value = $event),
                            align: "left"
                          }, {
                            default: withCtx(() => [
                              createVNode(QTab, {
                          ...
                          invoiceTab.value === "config" ? (openBlock(), createBlock(QCardSection, { key: 2 }, {
                            default: withCtx(() => [
                              createBaseVNode("div", _hoisted_23, [
                                createBaseVNode("div", _hoisted_24, [
                                  createVNode(_sfc_main$4, {
                                    ...
                                    "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => unref(localModel).invoice.invoice_date = $event),
                                    label: _ctx.$t("invoice.invoiceDate")
                                  }, null, 8, ["modelValue", "label"])
                                ]),
                                createVNode(QInput, {
                                  modelValue: unref(localModel).invoice.invoice_po,
                                  "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => unref(localModel).invoice.invoice_po = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => unref(localModel).invoice.invoice_name = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => unref(localModel).invoice.invoice_address1 = $event),
                                label: _ctx.$t("address.line1"),
                                "bottom-slots": ""
                              }, null, 8, ["modelValue", "label"]),
                              createVNode(QInput, {
                                modelValue: unref(localModel).invoice.invoice_address2,
                                "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => unref(localModel).invoice.invoice_address2 = $event),
                              ...
                              createBaseVNode("div", _hoisted_25, [
                                createVNode(_sfc_main$6, {
                                  ...
                                  "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => unref(localModel).invoice.invoice_address_suburb_postcode_region_id = $event),
                                  label: _ctx.$t("address.suburb"),
                                  class: "col-xs-12 col-sm-6"
                                }, null, 8, ["modelValue", "label"]),
                                createVNode(_sfc_main$7, {
                                  modelValue: unref(localModel).invoice.invoice_address_country_id,
                                  "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => unref(localModel).invoice.invoice_address_country_id = $event),
                              ...
                              createBaseVNode("div", _hoisted_26, [
                                createVNode(QBtn, {
                                  ...
                                  label: _ctx.$t("actions.update"),
                                  color: "primary",
                                  onClick: _cache[19] || (_cache[19] = ($event) => saveInvoice()),
                                  rounded: ""
                                }, null, 8, ["disable", "label"])
                              ])
                            ]),
