import { b as boot } from "./index.278ed024.js";
...
const getNavigationEntry = () => {
  if (WINDOW$1.__WEB_VITALS_POLYFILL__) {
    return WINDOW$1.performance && (performance.getEntriesByType && performance.getEntriesByType("navigation")[0] || getNavigationEntryFromPerformanceTiming());
  } else {
...
function addPerformanceEntries(transaction) {
  const performance2 = getBrowserPerformanceAPI();
  if (!performance2 || !WINDOW$1.performance.getEntries || !browserPerformanceTimeOrigin) {
    return;
  }
