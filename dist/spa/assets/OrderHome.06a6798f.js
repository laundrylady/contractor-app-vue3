...
import { _ as _sfc_main$1 } from "./PostcodeRegionDisplay.fe94bfcb.js";
import { _ as _sfc_main$3 } from "./StatusTag.373a50c2.js";
import { _ as _sfc_main$4 } from "./GlobalNotes.e8fdc3f7.js";
import { u as useMixinDebug } from "./debug.b9d7424b.js";
import { f as displayDateOrder, h as hourBookingDisplay, B as fromNowTz } from "./help.464b59aa.js";
...
const _hoisted_8 = { class: "q-mb-xs bg-white q-pa-md rounded-borders" };
const _hoisted_9 = { class: "row items-center" };
const _hoisted_10 = { class: "col-xs-12 col-sm-8" };
const _hoisted_11 = { class: "flex items-center" };
const _hoisted_12 = { class: "text-h5" };
const _hoisted_13 = { class: "q-mr-sm" };
                  ...
                  default: withCtx(() => [
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            createBaseVNode("a", {
                              ...
                              class: "link"
                            }, toDisplayString(model.value.team.mobile), 9, _hoisted_2)
                          ]),
                          _: 1
                        })
                      ]),
                    ...
                    createVNode(QItem, null, {
                      default: withCtx(() => [
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            model.value.scheduled_pickup_date ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString(unref(displayDateOrder)(model.value.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                            createTextVNode(),
                            model.value.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_4, "(" + toDisplayString(unref(hourBookingDisplay)(model.value.scheduled_pickup_time)) + ")", 1)) : createCommentVNode("", true)
                          ]),
                          _: 1
                        })
                      ]),
              ...
              createVNode(QPage, {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_6, [
                    !unref($q).screen.xs ? (openBlock(), createElementBlock("div", _hoisted_7, [
                    ...
                    createBaseVNode("div", _hoisted_8, [
                      createBaseVNode("div", _hoisted_9, [
                        createBaseVNode("div", _hoisted_10, [
                          createBaseVNode("div", _hoisted_11, [
                            ...
                            createBaseVNode("div", _hoisted_12, [
                              createBaseVNode("span", _hoisted_13, toDisplayString(_ctx.$t("order.name")) + " #" + toDisplayString(model.value.display_id), 1)
                            ]),
                            ...
                            createBaseVNode("div", null, [
                              createBaseVNode("div", null, [
                                ...
                                createVNode(_component_router_link, {
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(model.value.team.name) + " ", 1),
                                    model.value.team.name !== `${model.value.team.first_name} ${model.value.team.last_name}` ? (openBlock(), createElementBlock("span", _hoisted_15, "(" + toDisplayString(model.value.team.first_name) + " " + toDisplayString(model.value.team.last_name) + ")", 1)) : createCommentVNode("", true)
                                  ]),
                                  _: 1
                                }, 8, ["to"]),
                                _hoisted_16,
                                ...
                                model.value.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_17, " (" + toDisplayString(unref(hourBookingDisplay)(model.value.scheduled_pickup_time)) + ") ", 1)) : createCommentVNode("", true),
                          ...
                          model.value.team ? (openBlock(), createElementBlock("div", _hoisted_18, [
                            createVNode(QIcon, { name: "payments" }),
                            createTextVNode(" " + toDisplayString(model.value.team.payment_terms) + " - " + toDisplayString(model.value.team.payment_terms_days) + " days ", 1),
                        ...
                        !unref($q).screen.xs ? (openBlock(), createElementBlock("div", _hoisted_19, [
                          model.value.recurring_order && model.value.scheduled_pickup_time ? (openBlock(), createElementBlock("div", _hoisted_20, [
                            createVNode(QBadge, {
                              class: "q-pa-sm",
                              color: "secondary"
                            }, {
                          ...
                          model.value.status === "cancelled" ? (openBlock(), createElementBlock("span", _hoisted_21, " by " + toDisplayString(model.value.cancel_by), 1)) : createCommentVNode("", true),
                          model.value.cancel_reason ? (openBlock(), createElementBlock("div", _hoisted_22, toDisplayString(model.value.cancel_reason), 1)) : createCommentVNode("", true),
                          createBaseVNode("div", null, [
