...
import { _ as _sfc_main$3 } from "./OrderContractorManagement.ebc17fbd.js";
import { u as useMixinDebug } from "./debug.b9d7424b.js";
import { h as hourBookingDisplay, a as categoryDisplay, c as confirmDelete } from "./help.237e61c3.js";
import { p as productCategoriesVisibleBooking } from "./helpers.98455a9d.js";
import { _ as _sfc_main$2 } from "./AppLogo.b2fd20a1.js";
import { u as useMixinCommon } from "./common.b53a597f.js";
import { _ as _sfc_main$1, a as _sfc_main$4 } from "./HeaderComponent.05be325e.js";
...
const _hoisted_26 = { class: "col-xs-12 col-sm-5" };
const _hoisted_27 = /* @__PURE__ */ createBaseVNode("p", { class: "text-leftt text-bold text-grey" }, "CHOOSE THE SERVICES YOU REQUIRE:", -1);
const _hoisted_28 = { class: "flex" };
const _hoisted_29 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold q-mt-md" }, "SCHEDULED PICKUP DATE", -1);
const _hoisted_30 = {
  key: 0,
  class: "q-mt-md"
};
const _hoisted_31 = { class: "col-xs-12 col-sm-7" };
const _hoisted_32 = /* @__PURE__ */ createBaseVNode("div", { class: "text-grey text-bold q-mb-md" }, "SCHEDULED PICKUP TIME", -1);
const _hoisted_33 = {
  key: 7,
  class: "q-mt-xl"
};
        ...
        default: withCtx(() => [
          ...
          createVNode(QPageContainer, null, {
            default: withCtx(() => [
                            ...
                            default: withCtx(() => [
                              createVNode(QCardSection, null, {
                                default: withCtx(() => [
                                  ...
                                  model.value.status === "cancelled" ? (openBlock(), createElementBlock("div", _hoisted_18, [
                                    createVNode(QIcon, {
                                      name: "close",
                                      size: "20px"
                                    }),
                                    createTextVNode(" This booking has been cancelled: " + toDisplayString(model.value.cancel_reason), 1)
                                  ])) : createCommentVNode("", true),
                                  !model.value.canEdit ? (openBlock(), createElementBlock("div", _hoisted_19, [
                                    ...
                                    unref(common) ? (openBlock(), createElementBlock("a", {
                                      key: 0,
                                      href: model.value.support_url || "mailto:support@thelaundrylady.com.au",
                                      class: "link"
                                    }, "Support Team", 8, _hoisted_20)) : createCommentVNode("", true)
                                  ])) : createCommentVNode("", true),
                                  !showChange.value && !showCancel.value && model.value.canEdit ? (openBlock(), createElementBlock("div", _hoisted_21, [
                                    ...
                                    !canCancel.value && !canChange.value ? (openBlock(), createElementBlock("div", _hoisted_22, [
                                      createTextVNode(" *This Booking is within the 3 hour notification period of the agreed pickup time. "),
                                      model.value.contractor ? (openBlock(), createElementBlock("div", _hoisted_23, "Please contact " + toDisplayString(model.value.contractor.contractor_badge_name) + " on " + toDisplayString(model.value.contractor.mobile), 1)) : createCommentVNode("", true)
                                    ])) : createCommentVNode("", true)
                                  ])) : createCommentVNode("", true),
                                  ...
                                  showCancel.value && !showCancelSuccess.value ? (openBlock(), createElementBlock("div", _hoisted_33, [
                                    createVNode(QSelect, {
                                    ...
                                    model.value.recurringInfo.recurring_order ? (openBlock(), createBlock(QToggle, {
                                      key: 0,
                                      modelValue: model.value.cancel_recurring,
                                      "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => model.value.cancel_recurring = $event),
                              ...
                              createVNode(QCardActions, { align: "right" }, {
                                default: withCtx(() => [
                                  showChange.value && !showChangeSuccess.value ? (openBlock(), createElementBlock("div", _hoisted_34, [
                                    createVNode(QBtn, {
                                      onClick: _cache[11] || (_cache[11] = ($event) => showChange.value = false),
                                      label: "Cancel",
                                      color: "secondary",
                                      flat: "",
                                      rounded: "",
                                    ...
                                    createVNode(QBtn, {
                                      onClick: _cache[12] || (_cache[12] = ($event) => updateOrder()),
                                  ...
                                  showCancel.value && !showCancelSuccess.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
                                    createVNode(QBtn, {
                                      onClick: _cache[13] || (_cache[13] = ($event) => showCancel.value = false),
                                      label: "Reset",
                                      color: "secondary",
                                      flat: "",
                                      rounded: "",
                                    ...
                                    createVNode(QBtn, {
                                      onClick: _cache[14] || (_cache[14] = ($event) => cancelOrder()),
                                      disable: unref($v).$invalid,
              ...
              model.value && model.value.id ? (openBlock(), createElementBlock("div", _hoisted_36, [
