import { S as createComponent, r as ref, f as computed, h, N as QIcon, G as withDirectives, aq as Ripple, g as getCurrentInstance, i as inject, U as emptyRenderFn, bc as stepperKey, b9 as KeepAlive, V as hSlot, ab as useDarkProps, ac as useDark, Y as provide, a5 as hMergeSlot, ae as hDir, A as defineComponent, B as reactive, l as openBlock, m as createElementBlock, R as unref, J as createBlock, K as withCtx, k as createVNode, aG as createTextVNode, y as createCommentVNode, F as Fragment, bd as renderList, aH as toDisplayString, P as QBtn, p as createBaseVNode, a9 as useRoute, o as onMounted, Q as QCard, L as QCardSection, M as QInput, ai as QToggle, be as QCheckbox } from "./index.87bd49b7.js";
import { Q as QSlideTransition, _ as _sfc_main$6 } from "./CountryField.fe5a242f.js";
import { u as usePanelChildProps, a as usePanelProps, b as usePanelEmits, c as usePanel } from "./use-panel.ba12f271.js";
import { u as useCache } from "./use-cache.b0833c75.js";
import { Q as QUploader } from "./QUploader.c795ecd7.js";
import { Q as QPage } from "./QPage.77b4bc1c.js";
import { Q as QLayout, a as QPageContainer } from "./QLayout.1085c392.js";
import { u as useVuelidate, r as required, e as email, s as sameAs } from "./index.esm.0bc76624.js";
import { u as useQuasar } from "./use-quasar.a8a6e25c.js";
import { a as api } from "./axios.dbd6bbec.js";
import { _ as _sfc_main$3 } from "./AppLogo.63b6c22c.js";
import { a as QItem, Q as QItemSection } from "./QItemSection.0c4c4823.js";
import { Q as QList } from "./QList.f266a7fa.js";
import { u as uploadConfig, c as confirmDelete } from "./help.741e177a.js";
import { _ as _sfc_main$2 } from "./DateField.916a1ec9.js";
import { _ as _sfc_main$4, a as _sfc_main$5 } from "./PostcodeRegionField.2dc5273a.js";
...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h5" }, "Contractor Application Form", -1);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("p", null, "Please complete form below to proceed to the next steps.", -1);
const _hoisted_6 = { class: "row q-col-gutter-md q-mt-sm" };
...
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("p", null, "Please enter your current home / business address", -1);
const _hoisted_16 = { class: "row q-col-gutter-md q-mb-md" };
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, "Please ensure if these change in future you let us know", -1);
...
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, "Please include contact details of 2 referees. These can be personal or work referees. By including their details you agree to us contacting them for a reference check. Your formal offer will not be made until we have completed a satisfactory reference check.", -1);
...
const _hoisted_37 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, [
...
const _hoisted_38 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Are you registered for GST?", -1);
...
const _hoisted_40 = /* @__PURE__ */ createBaseVNode("p", { class: "q-mt-sm" }, "Commission will be paid to your nominated account. Please ensure this is completed or advised prior to any commission being due.", -1);
...
const _hoisted_48 = /* @__PURE__ */ createBaseVNode("p", null, "Please upload copies of the following documents.", -1);
const _hoisted_49 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs" }, "Copy of current Drivers Licence (front and back)", -1);
const _hoisted_50 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of current Medicare Card", -1);
const _hoisted_51 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "Copy of Certificate of Currency for Public Liability Insuranced ", -1);
...
const _hoisted_53 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-xs q-mt-md" }, "NDIS Workers Clearance Certificate", -1);
...
const _hoisted_59 = /* @__PURE__ */ createBaseVNode("p", { class: "text-caption" }, "Accepted file types: jpg, gif, png, pdf, Max. file size: 5 MB", -1);
const _hoisted_60 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm q-mt-sm" }, "Your Equipment", -1);
const _hoisted_61 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold q-mb-sm" }, "Please check the following", -1);
const _hoisted_62 = { class: "row q-col-gutter-md q-mt-sm" };
const _hoisted_63 = { class: "col-xs-12 col-sm-6" };
const _hoisted_64 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant One Signature", -1);
const _hoisted_65 = { style: { "border": "1px solid #efefef" } };
const _hoisted_66 = { class: "col-xs-12 col-sm-6" };
const _hoisted_67 = /* @__PURE__ */ createBaseVNode("div", { class: "text-bold" }, "Applicant Two Signature", -1);
const _hoisted_68 = { style: { "border": "1px solid #efefef" } };
