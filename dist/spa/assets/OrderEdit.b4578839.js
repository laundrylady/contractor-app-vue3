import { Q as QTab } from "./QTab.39b2a491.js";
import { Q as QTabs } from "./QTabs.458973e7.js";
import { B as defineComponent, r as ref, g as computed, i as inject, C as reactive, o as onMounted, m as openBlock, n as createElementBlock, q as createBaseVNode, F as Fragment, be as renderList, t as normalizeClass, ak as createTextVNode, aj as toDisplayString, S as unref, z as createCommentVNode, l as createVNode, bf as createSlots, L as withCtx, R as QBtn, N as QInput, O as QIcon, H as withDirectives, K as createBlock, bw as QSeparator, Q as QCard, M as QCardSection, ab as QCardActions, aH as QDialog, J as useRouter, by as resolveComponent, bg as QCheckbox, al as QToggle, bo as Dialog } from "./index.37c212b7.js";
import { Q as QBadge } from "./QBadge.780d835b.js";
import { Q as QSelect } from "./QSelect.45446517.js";
import { Q as QSpace } from "./QSpace.e8cfcac0.js";
import { Q as QExpansionItem } from "./QExpansionItem.c97cc597.js";
import { a as QItem, Q as QItemSection } from "./QItemSection.5e196a9b.js";
import { Q as QList } from "./QList.ac4209d2.js";
import { Q as QItemLabel } from "./QItemLabel.c603d020.js";
import { Q as QToolbar, a as QToolbarTitle } from "./QToolbarTitle.8ca06b52.js";
import { C as ClosePopup } from "./ClosePopup.097f38a2.js";
import { u as useVuelidate, r as required, a as requiredIf } from "./index.esm.4f6ef102.js";
import { a as api } from "./axios.9d82477c.js";
import { _ as _sfc_main$4 } from "./UserAvatar.cfbf8163.js";
import { _ as _sfc_main$8 } from "./AuditTimeline.b05d8552.js";
import { _ as _sfc_main$5, a as _sfc_main$6, b as _sfc_main$7 } from "./PostcodeRegionField.f6365915.js";
import { _ as _sfc_main$2 } from "./DateField.73e69296.js";
import { Q as QMenu } from "./QMenu.f3609a1c.js";
import { u as useMixinDebug } from "./debug.972d445d.js";
import { r as groupBy, j as currencyFormat, z as dateTimeTz, d as hourBookingOptions, c as confirmDelete, e as doNotify, b as arrayRange, h as hourBookingDisplay, D as agreedTimes, g as hourAgreedDisplay, f as displayDateDay, E as cancelOrderReasons, F as changeOrderReasonsDelivery, G as changeOrderReasons } from "./help.3174e283.js";
import { _ as _sfc_main$3 } from "./GlobalNotes.aa5335c9.js";
import { _ as _sfc_main$9 } from "./GlobalNotifications.36e596a9.js";
import { u as useMixinSecurity } from "./security.57cbed58.js";
import { p as productCategoriesVisibleBooking } from "./helpers.cb8d53d3.js";
import { u as useI18n } from "./vue-i18n.runtime.esm-bundler.caf13709.js";
import "./QResizeObserver.ee4fcc17.js";
import "./rtl.b51694b1.js";
import "./format.3e32b8d9.js";
import "./QSlideTransition.80f6f910.js";
import "./QImg.c1759230.js";
import "./use-ratio.f5aec3b2.js";
...
import "./common.b9dad1cf.js";
import "./common.3928969b.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
            ...
            createVNode(QList, null, {
              default: withCtx(() => [
                ...
                unref(localModel).status !== "cancelled" ? (openBlock(), createBlock(QExpansionItem, {
                  ...
                  "header-class": "text-h6",
                  "default-opened": "",
                  onClick: _cache[38] || (_cache[38] = ($event) => invoiceTab.value = "products")
                }, {
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                        ...
                        unref(localModel).invoice ? (openBlock(), createElementBlock("div", _hoisted_46, [
                          createVNode(QTabs, {
                            ...
                            "onUpdate:modelValue": _cache[29] || (_cache[29] = ($event) => invoiceTab.value = $event),
                            align: "left"
                          }, {
                            default: withCtx(() => [
                              createVNode(QTab, {
                          ...
                          invoiceTab.value === "config" ? (openBlock(), createBlock(QCardSection, { key: 2 }, {
                            default: withCtx(() => [
                              createBaseVNode("div", _hoisted_48, [
                                createBaseVNode("div", _hoisted_49, [
                                  createVNode(_sfc_main$2, {
                                    ...
                                    "onUpdate:modelValue": _cache[30] || (_cache[30] = ($event) => unref(localModel).invoice.invoice_date = $event),
                                    label: _ctx.$t("invoice.invoiceDate")
                                  }, null, 8, ["modelValue", "label"])
                                ]),
                                createVNode(QInput, {
                                  modelValue: unref(localModel).invoice.invoice_po,
                                  "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => unref(localModel).invoice.invoice_po = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => unref(localModel).invoice.invoice_name = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => unref(localModel).invoice.invoice_address1 = $event),
                                label: _ctx.$t("address.line1"),
                                "bottom-slots": ""
                              }, null, 8, ["modelValue", "label"]),
                              createVNode(QInput, {
                                modelValue: unref(localModel).invoice.invoice_address2,
                                "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => unref(localModel).invoice.invoice_address2 = $event),
                              ...
                              createBaseVNode("div", _hoisted_50, [
                                createVNode(_sfc_main$6, {
                                  ...
                                  "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => unref(localModel).invoice.invoice_address_suburb_postcode_region_id = $event),
                                  label: _ctx.$t("address.suburb"),
                                  class: "col-xs-12 col-sm-6"
                                }, null, 8, ["modelValue", "label"]),
                                createVNode(_sfc_main$7, {
                                  modelValue: unref(localModel).invoice.invoice_address_country_id,
                                  "onUpdate:modelValue": _cache[36] || (_cache[36] = ($event) => unref(localModel).invoice.invoice_address_country_id = $event),
                              ...
                              createBaseVNode("div", _hoisted_51, [
                                createVNode(QBtn, {
                                  ...
                                  label: _ctx.$t("actions.update"),
                                  color: "primary",
                                  onClick: _cache[37] || (_cache[37] = ($event) => saveInvoice()),
                                  rounded: ""
                                }, null, 8, ["disable", "label"])
                              ])
                            ]),
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[43] || (_cache[43] = ($event) => showCancelOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createVNode(QSelect, {
                      ...
                      "onUpdate:modelValue": _cache[39] || (_cache[39] = ($event) => unref(localModel).cancel_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => unref(localModel).cancel_notes = $event),
                    ...
                    createVNode(QCheckbox, {
                      ...
                      "onUpdate:modelValue": _cache[41] || (_cache[41] = ($event) => unref(localModel).cancel_rebook = $event),
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[42] || (_cache[42] = ($event) => cancelOrder()),
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[47] || (_cache[47] = ($event) => showChangesOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSelect, {
                      ...
                      "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => unref(localModel).changes_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[45] || (_cache[45] = ($event) => unref(localModel).changes_notes = $event),
                      label: "Extra notes for the customer",
                      type: "textarea",
                      rows: "3",
                      outlined: "",
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[46] || (_cache[46] = ($event) => doSave()),
