import { Q as QTab } from "./QTab.a47063b2.js";
import { Q as QTabs } from "./QTabs.d0d4ac97.js";
import { S as createComponent, ab as useDarkProps, af as useFormProps, ac as useDark, bp as useFormAttrs, r as ref, f as computed, w as watch, D as nextTick, b0 as position, V as hSlot, h, g as getCurrentInstance, ah as useFormInject, bf as vmIsDestroyed, H as Transition, G as withDirectives, P as QBtn, A as defineComponent, i as inject, B as reactive, o as onMounted, l as openBlock, m as createElementBlock, p as createBaseVNode, F as Fragment, bd as renderList, s as normalizeClass, aG as createTextVNode, aH as toDisplayString, R as unref, y as createCommentVNode, k as createVNode, bG as createSlots, K as withCtx, M as QInput, bu as QSeparator, N as QIcon, J as createBlock, Q as QCard, L as QCardSection, aa as QCardActions, aE as QDialog, bw as resolveComponent, ai as QToggle, be as QCheckbox } from "./index.b04b1049.js";
import { Q as QSelect } from "./QSelect.0f362143.js";
import { T as TouchPan } from "./TouchPan.a97cb9fb.js";
import { u as useDatetimeProps, a as useDatetimeEmits, b as useDatetime, _ as __splitDate, g as getDayHash, f as formatDate } from "./QDate.15e3664e.js";
import { p as pad } from "./format.3e32b8d9.js";
import { Q as QSpace } from "./QSpace.8c098adf.js";
import { Q as QExpansionItem } from "./QExpansionItem.c21c6236.js";
import { a as QItem, Q as QItemSection } from "./selection.347263e5.js";
import { Q as QList } from "./QList.02c43971.js";
import { Q as QItemLabel } from "./QItemLabel.21af0eb9.js";
import { Q as QToolbar, a as QToolbarTitle } from "./QToolbarTitle.5cee1261.js";
import { C as ClosePopup } from "./ClosePopup.6677deda.js";
import { u as useVuelidate, r as required } from "./index.esm.bae90351.js";
import { a as api } from "./axios.aaf6f9f0.js";
import { _ as _sfc_main$3 } from "./UserAvatar.c5895421.js";
import { _ as _sfc_main$8 } from "./AuditTimeline.4737cbf8.js";
import { _ as _sfc_main$5 } from "./AddressSearch.bb9f5098.js";
import { _ as _sfc_main$7 } from "./CountryField.c0f1338a.js";
import { _ as _sfc_main$4 } from "./DateField.7d890b21.js";
import { _ as _sfc_main$6 } from "./PostcodeRegionField.5c3e26ff.js";
import { Q as QMenu } from "./QMenu.53748de8.js";
import { u as useMixinDebug } from "./debug.ffa51329.js";
import { q as groupBy, g as currencyFormat, t as dateTimeTz, c as confirmDelete, d as doNotify, b as hourBookingOptions, f as hourAgreedDisplay, e as displayDateDay, h as hourBookingDisplay } from "./help.3cb757e9.js";
import { _ as _sfc_main$2 } from "./GlobalNotes.e20e86b1.js";
import { _ as _sfc_main$9 } from "./GlobalNotifications.2ff2a289.js";
import { u as useMixinSecurity } from "./security.23d6675b.js";
import { p as productCategoriesVisibleBooking } from "./helpers.7eb9620e.js";
import { u as useI18n } from "./vue-i18n.runtime.esm-bundler.dde8739a.js";
import "./QResizeObserver.718e3925.js";
import "./rtl.b51694b1.js";
import "./touch.3df10340.js";
import "./use-cache.b0833c75.js";
import "./QImg.90108011.js";
import "./use-ratio.5497cf2c.js";
...
const _hoisted_33 = { class: "text-grey-7" };
const _hoisted_34 = {
  key: 0,
  class: "q-mr-sm"
};
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
            ...
            createVNode(QList, null, {
              default: withCtx(() => [
                createVNode(QExpansionItem, {
                  ...
                  onClick: _cache[11] || (_cache[11] = ($event) => bookingTab.value = "details"),
                        ...
                        unref(canEdit) && bookingTab.value === "details" ? (openBlock(), createBlock(QCardActions, { key: 0 }, {
                          default: withCtx(() => [
                            unref(localModel).status !== "cancelled" && (!unref(localModel).invoice || unref(localModel).invoice && unref(localModel).invoice.status !== "PAID") ? (openBlock(), createBlock(QBtn, {
                              key: 0,
                              onClick: _cache[9] || (_cache[9] = ($event) => showCancelOrder.value = true),
                              color: "red",
                ...
                unref(localModel).status !== "cancelled" ? (openBlock(), createBlock(QExpansionItem, {
                  ...
                  "header-class": "text-h6",
                  "default-opened": "",
                  onClick: _cache[22] || (_cache[22] = ($event) => invoiceTab.value = "products")
                }, {
                  default: withCtx(() => [
                    createVNode(QCard, null, {
                      default: withCtx(() => [
                        !unref(localModel).invoice ? (openBlock(), createBlock(QCardSection, { key: 0 }, {
                          default: withCtx(() => [
                            ...
                            createVNode(QBtn, {
                              ...
                              onClick: _cache[12] || (_cache[12] = ($event) => createInvoice()),
                              color: "primary",
                              icon: "add_circle",
                              rounded: ""
                            })
                        ...
                        unref(localModel).invoice ? (openBlock(), createElementBlock("div", _hoisted_21, [
                          createVNode(QTabs, {
                            ...
                            "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => invoiceTab.value = $event),
                            align: "left"
                          }, {
                            default: withCtx(() => [
                              createVNode(QTab, {
                          ...
                          invoiceTab.value === "config" ? (openBlock(), createBlock(QCardSection, { key: 2 }, {
                            default: withCtx(() => [
                              createBaseVNode("div", _hoisted_23, [
                                createBaseVNode("div", _hoisted_24, [
                                  createVNode(_sfc_main$4, {
                                    ...
                                    "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => unref(localModel).invoice.invoice_date = $event),
                                    label: _ctx.$t("invoice.invoiceDate")
                                  }, null, 8, ["modelValue", "label"])
                                ]),
                                createVNode(QInput, {
                                  modelValue: unref(localModel).invoice.invoice_po,
                                  "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => unref(localModel).invoice.invoice_po = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => unref(localModel).invoice.invoice_name = $event),
                              ...
                              createVNode(QInput, {
                                ...
                                "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => unref(localModel).invoice.invoice_address1 = $event),
                                label: _ctx.$t("address.line1"),
                                "bottom-slots": ""
                              }, null, 8, ["modelValue", "label"]),
                              createVNode(QInput, {
                                modelValue: unref(localModel).invoice.invoice_address2,
                                "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => unref(localModel).invoice.invoice_address2 = $event),
                              ...
                              createBaseVNode("div", _hoisted_25, [
                                createVNode(_sfc_main$6, {
                                  ...
                                  "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => unref(localModel).invoice.invoice_address_suburb_postcode_region_id = $event),
                                  label: _ctx.$t("address.suburb"),
                                  class: "col-xs-12 col-sm-6"
                                }, null, 8, ["modelValue", "label"]),
                                createVNode(_sfc_main$7, {
                                  modelValue: unref(localModel).invoice.invoice_address_country_id,
                                  "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => unref(localModel).invoice.invoice_address_country_id = $event),
                              ...
                              createBaseVNode("div", _hoisted_26, [
                                createVNode(QBtn, {
                                  ...
                                  label: _ctx.$t("actions.update"),
                                  color: "primary",
                                  onClick: _cache[21] || (_cache[21] = ($event) => saveInvoice()),
                                  rounded: ""
                                }, null, 8, ["disable", "label"])
                              ])
                            ]),
                      ...
                      createBaseVNode("div", null, [
                        createBaseVNode("div", null, [
                          createVNode(_component_router_link, {
                            ...
                            default: withCtx(() => [
                              o.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_27, toDisplayString(unref(displayDateDay)(o.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                              createTextVNode(" " + toDisplayString(o.scheduled_pickup_date) + " (", 1),
                              !o.agreed_pickup_time && o.scheduled_pickup_time ? (openBlock(), createElementBlock("span", _hoisted_28, toDisplayString(unref(hourBookingDisplay)(o.scheduled_pickup_time)), 1)) : createCommentVNode("", true),
                        ...
                        createBaseVNode("div", _hoisted_33, [
                          ...
                          createTextVNode(),
                          o.team.suburbpostcoderegion ? (openBlock(), createElementBlock("span", _hoisted_34, toDisplayString(o.team.suburbpostcoderegion.locality) + " " + toDisplayString(o.team.suburbpostcoderegion.state), 1)) : createCommentVNode("", true)
                        ])
                      ])
                    ]),
                    _: 2
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => showCancelOrder.value = $event)
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createVNode(QSelect, {
                      ...
                      "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => unref(localModel).cancel_reason = $event),
                    ...
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => unref(localModel).cancel_notes = $event),
                    ...
                    createVNode(QCheckbox, {
                      ...
                      "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => unref(localModel).cancel_rebook = $event),
                ...
                createVNode(QCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(QSpace),
                    createVNode(QBtn, {
                      onClick: _cache[26] || (_cache[26] = ($event) => cancelOrder()),
