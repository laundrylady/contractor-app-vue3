            ...
            notificationHistory.value && notificationHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_20$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(notificationHistory.value, (n) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  n.subject && n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_21$1, "Sent for payment ")) : createCommentVNode("", true),
                  ...
                  n.subject && !n.subject.match("reminder") && !n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_23$1, "Invoice emailed ")) : createCommentVNode("", true),
                  createTextVNode(" to "),
