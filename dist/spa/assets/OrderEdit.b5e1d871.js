...
const _hoisted_21$1 = { class: "q-mt-md items-center q-pb-md" };
const _hoisted_22$1 = { class: "flex" };
const _hoisted_23$1 = { key: 0 };
const _hoisted_24$1 = { key: 0 };
const _hoisted_25$1 = { key: 1 };
const _hoisted_26$1 = { key: 2 };
const _hoisted_27$1 = { class: "text-wrap" };
const _hoisted_28$1 = { key: 0 };
const _hoisted_29$1 = { key: 0 };
const _hoisted_30$1 = /* @__PURE__ */ createBaseVNode("p", null, "Please confirm the scheduled delivery date & time below:", -1);
const _hoisted_31$1 = { class: "row q-col-gutter-md" };
const _hoisted_32$1 = { class: "col-xs-12 col-sm-6" };
const _hoisted_33$1 = { class: "col-xs-12 col-sm-6" };
const _hoisted_34$1 = /* @__PURE__ */ createBaseVNode("p", null, "Please confirm the scheduled delivery date & time below:", -1);
const _hoisted_35$1 = { class: "row q-col-gutter-md" };
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$2, [
          ...
          unref(canEdit) ? (openBlock(), createElementBlock("div", _hoisted_18$1, [
            unref(localModel).total_price > 0 && unref(localModel).status !== "PAID" ? (openBlock(), createElementBlock("div", _hoisted_19$1, [
              createTextVNode("Payment link: "),
              createBaseVNode("a", {
                href: `/payments/session/${unref(localModel).id}`,
                class: "link"
              }, "Click here to make a payment", 8, _hoisted_20$1)
            ])) : createCommentVNode("", true)
          ])) : createCommentVNode("", true),
          createVNode(QInput, {
          ...
          createBaseVNode("div", _hoisted_21$1, [
            ...
            notificationHistory.value && notificationHistory.value.length ? (openBlock(), createElementBlock("div", _hoisted_23$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(notificationHistory.value, (n) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  n.subject && n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_24$1, "Sent for payment ")) : createCommentVNode("", true),
                  n.subject && n.subject.match("reminder") ? (openBlock(), createElementBlock("span", _hoisted_25$1, "Payment reminder ")) : createCommentVNode("", true),
                  n.subject && !n.subject.match("reminder") && !n.subject.match("Ready For Payment") ? (openBlock(), createElementBlock("span", _hoisted_26$1, "Invoice emailed ")) : createCommentVNode("", true),
                  createTextVNode(" to "),
                  createBaseVNode("span", _hoisted_27$1, [
                    createTextVNode(toDisplayString(n.to), 1),
                    n.cc && n.cc.length ? (openBlock(), createElementBlock("span", _hoisted_28$1, [
            ...
            createVNode(QCard, { class: "modal" }, {
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    !unref(hasPickupNoShow) ? (openBlock(), createElementBlock("div", _hoisted_29$1, [
                      _hoisted_30$1,
