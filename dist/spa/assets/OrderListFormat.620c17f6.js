                        ...
                        createBaseVNode("div", null, [
                          createBaseVNode("div", null, [
                            ...
                            element.status !== "ready_for_delivery" ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                element.scheduled_pickup_date ? (openBlock(), createElementBlock("span", _hoisted_21, toDisplayString(unref(displayDateOrder)(element.scheduled_pickup_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" ("),
                            ...
                            element.status === "ready_for_delivery" && element.scheduled_delivery_date && (element.agreed_pickup_time || element.scheduled_pickup_time) ? (openBlock(), createBlock(_component_router_link, {
                              ...
                              default: withCtx(() => [
                                element.scheduled_delivery_date ? (openBlock(), createElementBlock("span", _hoisted_24, toDisplayString(unref(displayDateOrder)(element.scheduled_delivery_date)), 1)) : createCommentVNode("", true),
                                createTextVNode(" ("),
