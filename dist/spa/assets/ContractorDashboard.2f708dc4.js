...
const _hoisted_31 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, " Owing ", -1);
const _hoisted_32 = { class: "col-xs-12 col-sm-6" };
const _hoisted_33 = /* @__PURE__ */ createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Bookings", -1);
const _hoisted_34 = { class: "row q-col-gutter-md" };
const _hoisted_35 = { class: "col-xs-6" };
const _hoisted_36 = { class: "text-h6 text-center" };
const _hoisted_37 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, "Total", -1);
const _hoisted_38 = { class: "col-xs-6" };
const _hoisted_39 = { class: "text-h6 text-center" };
const _hoisted_40 = /* @__PURE__ */ createBaseVNode("div", { class: "text-center" }, " Recurring ", -1);
const _hoisted_41 = { class: "col-xs-12 col-sm-6" };
const _hoisted_42 = { class: "text-h6 q-mb-md" };
const _hoisted_43 = { class: "text-center" };
const _hoisted_44 = { class: "q-mt-sm" };
const _hoisted_45 = { class: "col-xs-12 col-sm-6" };
const _hoisted_46 = { class: "text-h6 q-mb-md" };
const _hoisted_47 = { class: "text-center" };
const _hoisted_48 = { class: "q-mt-sm" };
const _hoisted_49 = { class: "text-h6" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.model.id && dashboard.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_25, [
                      ...
                      createBaseVNode("div", _hoisted_29, [
                        createBaseVNode("div", _hoisted_30, toDisplayString(unref(currencyFormat)(dashboard.value.totalOrdersTotalOwing[0].sum)), 1),
                        _hoisted_31
                      ])
                    ])
                  ]),
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", _hoisted_34, [
                      createBaseVNode("div", _hoisted_35, [
                        createBaseVNode("div", _hoisted_36, toDisplayString(dashboard.value.totalOrdersCount[0].count), 1),
                        _hoisted_37
                      ]),
                      createBaseVNode("div", _hoisted_38, [
                        createBaseVNode("div", _hoisted_39, toDisplayString(dashboard.value.totalOrdersCountRecurring[0].count), 1),
                        _hoisted_40
                      ])
                    ])
                  ]),
          ...
          createBaseVNode("div", _hoisted_41, [
            createVNode(QCard, { class: "fit" }, {
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_42, toDisplayString(_ctx.$t("team.namePlural")) + " Rebooked", 1),
                    createBaseVNode("div", _hoisted_43, [
                      ...
                      createBaseVNode("div", _hoisted_44, "Rebooked (" + toDisplayString(dashboard.value.retainedRebooked.rebookedPercentage) + "%)", 1)
                    ])
                  ]),
                  _: 1
                })
          ...
          createBaseVNode("div", _hoisted_45, [
            createVNode(QCard, { class: "fit" }, {
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_46, toDisplayString(_ctx.$t("team.namePlural")) + " Retained", 1),
                    createBaseVNode("div", _hoisted_47, [
                      ...
                      createBaseVNode("div", _hoisted_48, " Retained (" + toDisplayString(dashboard.value.retainedRebooked.retainedPercentage) + "%) ", 1)
                    ])
                  ]),
                  _: 1
                })
        ...
        createBaseVNode("div", _hoisted_49, "Current " + toDisplayString(_ctx.$t("schedule.name")), 1),
        _hoisted_50,
